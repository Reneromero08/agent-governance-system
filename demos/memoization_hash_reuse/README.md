...
All artifacts are committed under `CONTRACTS/_runs/_demos/memoization_hash_reuse/`.
...
```bash
cd demos/memoization_hash_reuse
bash verify.sh
```
...
```bash
cd CONTRACTS/_runs/_demos/memoization_hash_reuse
