...
def main() -> int:
    ...
    ap.add_argument("--out-root", default="CONTRACTS/_runs/_CONTEXT/demos/memoization_hash_reuse")
    args = ap.parse_args()
    ...
    deref_stats_rel = "CONTRACTS/_runs/_tmp/CONTEXT/demos/memoization_hash_reuse/deref_stats.json"
    deref_stats_abs = REPO_ROOT / deref_stats_rel
    deref_stats_baseline_rel = "CONTRACTS/_runs/_tmp/CONTEXT/demos/memoization_hash_reuse/deref_stats_baseline.json"
    deref_stats_baseline_abs = REPO_ROOT / deref_stats_baseline_rel
    deref_stats_reuse_rel = "CONTRACTS/_runs/_tmp/CONTEXT/demos/memoization_hash_reuse/deref_stats_reuse.json"
