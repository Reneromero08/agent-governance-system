...
- Baseline artifacts: `CONTRACTS/_runs/_CONTEXT/demos/memoization_hash_reuse/baseline/`
- Reuse artifacts: `CONTRACTS/_runs/_CONTEXT/demos/memoization_hash_reuse/reuse/`
- Comparison table: `CONTRACTS/_runs/_CONTEXT/demos/memoization_hash_reuse/comparison.md`
...
- `python CATALYTIC-DPT/CONTEXT/demos/memoization_hash_reuse/run_demo.py`
...
- writes/overwrites the demo artifacts under `CONTRACTS/_runs/_CONTEXT/demos/memoization_hash_reuse/`
