...
Deliverables
- [x] SCHEMAS/jobspec.schema.json
- [x] SCHEMAS/validation_error.schema.json
- [x] SCHEMAS/ledger.schema.json
...
- [x] Optional fields require documented default behavior.
...
Implementation note: `CATALYTIC-DPT/TESTBENCH/test_schemas.py` loads the three Draft-07 schemas, checks them via `jsonschema.Draft7Validator`, and asserts that every valid fixture from `FIXTURES/phase0/valid/` passes while every invalid fixture under `FIXTURES/phase0/invalid/` emits at least one schema error.
