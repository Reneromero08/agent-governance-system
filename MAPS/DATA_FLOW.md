...
7. **Update memory** - If the work is completed, the packer serialises the current state into a pack for future sessions under `MEMORY/LLM-PACKER/_packs/`. The manifest includes file hashes and canon version.
