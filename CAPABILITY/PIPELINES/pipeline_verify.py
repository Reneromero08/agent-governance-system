...
from CAPABILITY.PIPELINES.pipeline_runtime import _slug
from CAPABILITY.PRIMITIVES.ledger import Ledger, _LEDGER_VALIDATOR  # type: ignore
...
def verify_pipeline(
    *,
    ...
    for idx, entry in enumerate(steps):
        ...
        try:
            from CAPABILITY.TOOLS.catalytic.catalytic_validator import CatalyticLedgerValidator  # type: ignore
