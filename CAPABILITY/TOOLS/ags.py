...
DEFAULT_CAPABILITIES_PATH = "LAW/CANON/CAPABILITIES.json"
DEFAULT_PINS_PATH = "LAW/CANON/CAPABILITY_PINS.json"
DEFAULT_REVOKES_PATH = "LAW/CANON/CAPABILITY_REVOKES.json"
