...
### START OF FILE: test_invariants.db
...
f�	�0	��4���                                                                                                                                                                                                                                                                   �I/�?triggertr_messages_append_only_updatecassette_messagesCREATE TRIGGER tr_messages_append_only_update
        ...
        �//�Etablecassette_receiptscassette_receiptsCREATE TABLE cassette_receipts (
            ...
            )AU/ indexsqlite_autoindex_cassette_receipts_1cassette_receipts�
...
CREATE INDEX idx_steps_job_ordinal 
        ...
        �j
))�tablecassette_stepscassette_stepsCREATE TABLE cassette_steps (
...
CREATE INDEX idx_jobs_message_id 
        ...
        �
''�Stablecassette_jobscassette_jobsCREATE TABLE cassette_jobs (
            ...
            )9M' indexsqlite_autoindex_cassette_jobs_1cassette_jobs	�3/�Kindexidx_messages_run_idcassette_messagesCREATE INDEX idx_messages_run_id 
            ON cassette_messages(run_id, created_at)
        �U//�Ytablecassette_messagescassette_messagesCREATE TABLE cassette_messages (
...
    � �5�
�=
$	���G� �                                                                                                                     �aO)�Utriggertr_steps_lease_prevent_direct_setcassette_stepsCREATE TRIGGER tr_steps_lease_prevent_direct_set
            ...
            END�G9)�7triggertr_steps_fsm_illegal_3cassette_stepsCREATE TRIGGER tr_steps_fsm_illegal_3
            ...
            END�C9)�/triggertr_steps_fsm_illegal_2cassette_stepsCREATE TRIGGER tr_steps_fsm_illegal_2
            BEFORE UPDATE OF status ON cassette_steps
            WHEN NEW.status = 'PENDING' AND OLD.status = 'LEASED'
            BEGIN
                SELECT RAISE(ABORT, 'Illegal FSM transition: LEASED -> PENDING');
            END�I9)�;triggertr_steps_fsm_illegal_1cassette_stepsCREATE TRIGGER tr_steps_fsm_illegal_1
            BEFORE UPDATE OF status ON cassette_steps
...
### END OF FILE: test_invariants.db
...
### START OF FILE: catalytic_chat\experimental\vector_store.py
...
### END OF FILE: catalytic_chat\experimental\vector_store.py


---

### START OF FILE: CORTEX\db\system1.db
...
�
g*
"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  �u11�tablesection_index_metasection_index_metaCREATE TABLE section_index_meta (
                    key TEXT PRIMARY KEY,
                    value TEXT NOT NULL,
                    updated_at TEXT DEFAULT CURRENT_TIMESTAMP
                )CW1 indexsqlite_autoindex_section_index_meta_1section_index_meta]/}indexidx_sections_hashsectionsCREATE INDEX idx_sections_hash ON sections(content_hash)Z/windexidx_sections_filesectionsCREATE INDEX idx_sections_file ON sections(file_path)�"�tablesectionssectionsCREATE TABLE sections (
                    section_id TEXT PRIMARY KEY,
                    file_path TEXT NOT NULL,
                    heading_path TEXT NOT NULL,
                    line_start INTEGER NOT NULL,
...
### END OF FILE: CORTEX\db\system1.db
...
### END OF FILE: CORTEX\_generated\system3.db
...
SQLite format 3   @                                                                     .v�
� � (�g�	����	i�c�a�u�j�Y�                                                                                                                                                                                                                                                                                                                             �3+�5indexidx_vectors_createdmessage_vectorsCREATE INDEX idx_vectors_created
            ON message_vectors(created_at)
...
CREATE TABLE 'message_fts_idx'(segid, term, pgno, PRIMARY KEY(segid, term)) WITHOUT ROWIDp--�tablemessage_fts_datamessage_fts_dataCREATE TABLE 'message_fts_data'(id INTEGER PRIMARY KEY, block BLOB)�[##�tablemessage_ftsmessage_ftsCREATE VIRTUAL TABLE message_fts USING fts5(
                content,
                chunk_id UNINDEXED,
                role,
                tokenize='porter unicode61'
...
Q+ indexsqlite_autoindex_message_vectors_1message_vectors�p))�tablemessage_chunksmessage_chunksCREATE TABLE message_chunks (
                chunk_id INTEGER PRIMARY KEY AUTOINCREMENT,
                message_id INTEGER NOT NULL,
                chunk_index INTEGER NOT NULL,
                chunk_hash TEXT NOT NULL UNIQUE,
...
