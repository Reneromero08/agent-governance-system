...
from CAPABILITY.PIPELINES.pipeline_dag import restore_dag, run_dag, verify_dag
...
def _resolve_cas_root(*, run_id: str | None, cas_root: str | None) -> Path:
    ...
    return REPO_ROOT / "LAW" / "CONTRACTS" / "_runs" / run_id / "CAS"
...
def _resolve_ledger_path(*, run_id: str | None) -> Path | None:
    ...
    if run_id is None:
        return None
    return REPO_ROOT / "LAW" / "CONTRACTS" / "_runs" / run_id / "LEDGER.jsonl"
...
def main() -> int:
    ...
    status_p.add_argument("--runs-root", default="LAW/CONTRACTS/_runs", help="Runs root (default: LAW/CONTRACTS/_runs)")
    ...
    verify_p.add_argument("--runs-root", default="LAW/CONTRACTS/_runs", help="Runs root (default: LAW/CONTRACTS/_runs)")
    ...
    dag_run_p.add_argument("--runs-root", default="LAW/CONTRACTS/_runs", help="Runs root (default: LAW/CONTRACTS/_runs)")
    ...
    dag_status_p.add_argument("--runs-root", default="LAW/CONTRACTS/_runs", help="Runs root (default: LAW/CONTRACTS/_runs)")
    ...
    dag_verify_p.add_argument("--runs-root", default="LAW/CONTRACTS/_runs", help="Runs root (default: LAW/CONTRACTS/_runs)")
    ...
    dag_restore_p.add_argument("--runs-root", default="LAW/CONTRACTS/_runs", help="Runs root (default: LAW/CONTRACTS/_runs)")
    ...
    try:
        if args.cmd == "pipeline":
            if getattr(args, "runs_root", "LAW/CONTRACTS/_runs") != "LAW/CONTRACTS/_runs":
