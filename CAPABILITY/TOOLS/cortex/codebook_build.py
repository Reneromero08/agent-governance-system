...
def extract_skills(skills_dir: Path) -> List[Dict]:
    """Extract skills from CAPABILITY.SKILLS directory."""
    skills = []
...
def generate_markdown(codebook: Dict) -> str:
    ...
    lines.extend([
        ...
        "### In Code",
        "```python",
        "from CAPABILITY.TOOLS.codebook_lookup import lookup",
...
def main():
    ...
    try:
        ...
        from CAPABILITY.TOOLS.provenance import generate_header, add_header_to_content
