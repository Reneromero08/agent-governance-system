...
from CAPABILITY.PRIMITIVES.verify_bundle import BundleVerifier, ERROR_CODES, ED25519_AVAILABLE

@pytest.fixture
def test_base():
    base = REPO_ROOT / "LAW" / "CONTRACTS" / "_runs" / "_test_verifier_freeze"
...
@pytest.fixture
def verifier():
    return BundleVerifier(project_root=REPO_ROOT)
