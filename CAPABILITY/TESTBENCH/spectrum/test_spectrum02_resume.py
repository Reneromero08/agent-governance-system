...
Run: python CAPABILITY/TESTBENCH/spectrum/test_spectrum02_resume.py
"""
...
class RunnerSPECTRUM02Resume:
    ...
    def __init__(self):
        ...
        self.failed = 0
        self.errors = []
        self.test_root = REPO_ROOT / "LAW" / "CONTRACTS" / "_runs" / "_spectrum02_test"
    ...
    def _create_valid_bundle(self, bundle_name: str) -> Path:
        ...
        # Create output file
        output_rel = f"LAW/CONTRACTS/_runs/_spectrum02_test/{bundle_name}/output.txt"
