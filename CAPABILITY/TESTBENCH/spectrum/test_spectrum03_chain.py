...
Run: python CAPABILITY/TESTBENCH/spectrum/test_spectrum03_chain.py
"""
...
class RunnerSPECTRUM03Chain:
    ...
    def __init__(self):
        ...
        self.test_base = REPO_ROOT / "LAW" / "CONTRACTS" / "_runs" / "_test_spectrum03"
    ...
    def _create_minimal_run(
        ...
        output_rel = f"LAW/CONTRACTS/_runs/_test_spectrum03/{run_id}/out/{output_filename}"
