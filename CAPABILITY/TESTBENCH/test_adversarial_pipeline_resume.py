        ...
        "steps": [
            {
                ...
                "cmd": [
                    sys.executable,
                    "-c", f"from pathlib import Path; Path(r'{out1}').parent.mkdir(parents=True, exist_ok=True); Path(r'{out1}').write_text('ONE', encoding='utf-8')",
                ],
                "strict": True,
                "memoize": False,
            },
            {
                ...
                "cmd": [
                    sys.executable,
                    "-c", f"from pathlib import Path; Path(r'{out2}').parent.mkdir(parents=True, exist_ok=True); Path(r'{out2}').write_text('TWO', encoding='utf-8')",
                ],
                "strict": True,
                "memoize": False,
            },
