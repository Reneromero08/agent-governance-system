...
TEST_PHRASES = [
    ...
    "Culture influences individual behavior and beliefs.",
    "Freedom comes with corresponding responsibilities.",
    "Justice requires fair treatment under the law.",
    "Innovation drives economic progress and change.",
    "Education expands opportunities for personal growth.",
    # Technical statements (10)
    ...
    "Networks connect devices through standardized protocols.",
    "Sensors convert physical signals into digital data.",
    "Caching improves performance by storing frequent data.",
    # Narrative statements (10)
    ...
    "Patience leads to better outcomes in complex situations.",
    "Creativity flourishes when constraints are embraced.",
    "Collaboration produces results beyond individual capability.",
    "Resilience helps people recover from setbacks.",
    "Empathy strengthens connections between people.",
    ...
    # Historical and geographical (10)
    "History records the story of human civilization.",
    "Geography maps the features of Earth's surface.",
    "Archaeology uncovers evidence of past cultures.",
    "Anthropology studies human societies and behaviors.",
    "Economics analyzes the production of goods and services.",
    "Sociology examines social structures and relationships.",
    "Psychology investigates mental processes and behavior.",
    "Philosophy questions the nature of existence.",
    "Art expresses human creativity and emotion.",
    "Music combines rhythm and melody into harmony.",
    # Engineering and design (10)
    "Bridges span gaps using structural engineering principles.",
    "Skyscrapers resist wind through careful design.",
    "Airplanes generate lift through wing aerodynamics.",
    "Cars convert fuel into mechanical motion.",
    "Rockets overcome gravity through thrust and propulsion.",
    "Dams control water flow for power generation.",
    "Tunnels connect locations through underground passages.",
    "Solar panels convert sunlight into electricity.",
    "Wind turbines harness air movement for energy.",
    "Batteries store electrical energy in chemical form.",
    # Medical and biological (10)
    "Vaccines train the immune system against diseases.",
    "Antibiotics target bacterial infections selectively.",
    "Surgery repairs damaged tissues and organs.",
    "Nutrition provides essential building blocks for cells.",
    "Exercise strengthens muscles and improves health.",
    "Sleep allows the brain to consolidate memories.",
    "Hormones regulate bodily functions through chemical signals.",
    ...
    # Mathematics and logic (10)
    "Addition combines numbers to produce their sum.",
    "Multiplication repeats addition a specified number of times.",
    "Geometry studies shapes and spatial relationships.",
    "Statistics analyzes data to find patterns and trends.",
    "Calculus measures rates of change and accumulation.",
    "Logic provides rules for valid reasoning.",
    "Probability quantifies uncertainty in outcomes.",
    ...
    # Environmental and ecological (10)
    "Forests absorb carbon dioxide from the atmosphere.",
    "Oceans regulate global temperature through currents.",
    "Coral reefs support diverse marine ecosystems.",
    "Wetlands filter pollutants from water naturally.",
    "Glaciers store fresh water in frozen form.",
    "Deserts receive minimal rainfall throughout the year.",
    "Volcanoes release gases and lava from underground.",
