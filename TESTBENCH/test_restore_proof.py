...
Run:
    pytest CATALYTIC-DPT/TESTBENCH/test_restore_proof.py -v
"""
...
def proof_schema_path(repo_root):
    return repo_root / "CATALYTIC-DPT" / "SCHEMAS" / "proof.schema.json"
...
def test_identical_artifacts_verified_true(validator):
    ...
    assert proof["catalytic_domains"] == ["CATALYTIC-DPT/_scratch"]
...
def test_empty_domains_verified_true(validator):
    ...
    pre_state = {"CATALYTIC-DPT/_scratch": {}}
    post_state = {"CATALYTIC-DPT/_scratch": {}}
