...
- **[INV-006] Output roots** - System-generated artifacts must be written only to `LAW/CONTRACTS/_runs/`, `CORTEX/_generated/`, or `MEMORY/LLM_PACKER/_packs/`. `BUILD/` is reserved for user outputs.
