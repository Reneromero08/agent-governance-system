...
- [SPECTRUM-04: Validator Identity and Signing Law](SPECTRUM-04_IDENTITY_SIGNING.md)
- [SPECTRUM-05: Verification and Threat Law](SPECTRUM-05_VERIFICATION_LAW.md)
- [SPECTRUM-06: Restore Runner Semantics](SPECTRUM-06_RESTORE_RUNNER.md)
- [CMP-01: Catalytic Mutation Protocol](CMP-01_CATALYTIC_MUTATION_PROTOCOL.md)
