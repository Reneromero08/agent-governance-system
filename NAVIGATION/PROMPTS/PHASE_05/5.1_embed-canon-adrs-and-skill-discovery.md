...
phase: 5
task_id: "5.1"
slug: "embed-canon-adrs-and-skill-discovery"
...
depends_on: []
primary_model: "GPT-5.2-Codex (Reasoning: Medium)"
fallback_chain: ["Claude Sonnet (Reasoning: High)", "Gemini Pro (Reasoning: High)"]
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/5.1_embed-canon-adrs-and-skill-discovery/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/5.1_embed-canon-adrs-and-skill-discovery/REPORT.md"
...
- Primary model: GPT-5.2-Codex (Reasoning: Medium)
- Fallback chain: use only if required to reach DONE = GREEN.

## GOAL
Execute task **5.1** (embed-canon-adrs-and-skill-discovery) exactly as specified, without scope drift.
...
```text
ROLE + MODEL
- Primary: GPT-5.2-Codex (Thinking: Medium)
- Fallback chain: Claude Sonnet 4.5 (non-thinking) -> Claude Opus 4.5 (Thinking) -> Gemini 3 Pro (High)

GOAL
Implement **5.1 Embed Canon, ADRs, and Skill Discovery (Z.5)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/5-1-embed-canon-adrs-and-skill-discovery-z-5/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/5-1-embed-canon-adrs-and-skill-discovery-z-5/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/5-1-embed-canon-adrs-and-skill-discovery-z-5/REPORT.md
  - Must include:
...
- receipt_path: LAW/CONTRACTS/_runs/_tmp/prompts/5.1_embed-canon-adrs-and-skill-discovery-z-5/receipt.json
- report_path: LAW/CONTRACTS/_runs/_tmp/prompts/5.1_embed-canon-adrs-and-skill-discovery-z-5/REPORT.md
