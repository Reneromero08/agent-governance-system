...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/5.1_embed-canon-adrs-and-skill-discovery/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/5.1_embed-canon-adrs-and-skill-discovery/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/5.1_embed-canon-adrs-and-skill-discovery/REPORT.md
  - Must include:
