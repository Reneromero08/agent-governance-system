...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/3.4_session-persistence/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/3.4_session-persistence/REPORT.md"
...
## GOAL
Execute task **3.4** (session-persistence) exactly as specified, without scope drift.
...
GOAL
Implement **3.4 Session Persistence (Z.3.4)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/3-4-session-persistence-z-3-4/  (receipts + report only)
...
title = "3.4 Session Persistence (Z.3.4)"
start = None
...
- Identify the minimal touch set BEFORE editing:
  - `rg -n "3.4" -S .`
  - `rg -n "3.4" -S NAVIGATION/ROADMAPS/AGS_ROADMAP_MASTER_REPHASED_TODO_UPDATED.md`
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/3-4-session-persistence-z-3-4/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/3-4-session-persistence-z-3-4/REPORT.md
  - Must include:
...
- receipt_path: LAW/CONTRACTS/_runs/_tmp/prompts/3.4_session-persistence-z-3-4/receipt.json
- report_path: LAW/CONTRACTS/_runs/_tmp/prompts/3.4_session-persistence-z-3-4/REPORT.md
