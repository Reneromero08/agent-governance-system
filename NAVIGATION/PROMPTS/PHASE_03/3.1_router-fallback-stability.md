...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/3.1_router-fallback-stability/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/3.1_router-fallback-stability/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/3.1_router-fallback-stability/REPORT.md
  - Must include:
