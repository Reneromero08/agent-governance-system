...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/3.3_tool-binding/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/3.3_tool-binding/REPORT.md"
...
## GOAL
Execute task **3.3** (tool-binding) exactly as specified, without scope drift.
...
GOAL
Implement **3.3 Tool Binding (Z.3.3)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/3-3-tool-binding-z-3-3/  (receipts + report only)
...
- Identify the minimal touch set BEFORE editing:
  - `rg -n "3.3" -S .`
  - `rg -n "3.3" -S NAVIGATION/ROADMAPS/AGS_ROADMAP_MASTER_REPHASED_TODO_UPDATED.md`
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/3-3-tool-binding-z-3-3/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/3-3-tool-binding-z-3-3/REPORT.md
  - Must include:
...
- receipt_path: LAW/CONTRACTS/_runs/_tmp/prompts/3.3_tool-binding-z-3-3/receipt.json
- report_path: LAW/CONTRACTS/_runs/_tmp/prompts/3.3_tool-binding-z-3-3/REPORT.md
