...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/3.2_memory-integration/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/3.2_memory-integration/REPORT.md"
...
## GOAL
Execute task **3.2** (memory-integration) exactly as specified, without scope drift.
...
GOAL
Implement **3.2 Memory Integration (Z.3.2)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/3-2-memory-integration-z-3-2/  (receipts + report only)
...
title = "3.2 Memory Integration (Z.3.2)"
start = None
...
- Identify the minimal touch set BEFORE editing:
  - `rg -n "3.2" -S .`
  - `rg -n "3.2" -S NAVIGATION/ROADMAPS/AGS_ROADMAP_MASTER_REPHASED_TODO_UPDATED.md`
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/3-2-memory-integration-z-3-2/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/3-2-memory-integration-z-3-2/REPORT.md
  - Must include:
...
- receipt_path: LAW/CONTRACTS/_runs/_tmp/prompts/3.2_memory-integration-z-3-2/receipt.json
- report_path: LAW/CONTRACTS/_runs/_tmp/prompts/3.2_memory-integration-z-3-2/REPORT.md
