...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/9.4_governor-pattern/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/9.4_governor-pattern/REPORT.md"
...
## GOAL
Execute task **9.4** (Governor Pattern for Ant Workers (Z.6.4)) exactly as specified, without scope drift.

## CONTEXT
Implement governor pattern to constrain and coordinate ant workers in swarm.

## OBJECTIVE
Design and implement governance constraints for autonomous worker agents.
...
## CHECKLIST
- [ ] 9.4.1 Define governor constraint schema
- [ ] 9.4.2 Implement budget/throttle controls
- [ ] 9.4.3 Build approval workflow for constrained actions
- [ ] 9.4.4 Add violation detection and handling
