...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/9.5_delegation-protocol/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/9.5_delegation-protocol/REPORT.md"
...
## GOAL
Execute task **9.5** (Delegation Protocol (D.1)) exactly as specified, without scope drift.

## CONTEXT
Define JSON directive schema for delegated subtasks between governor and workers.

## OBJECTIVE
Create comprehensive delegation protocol for producer/verifier, patch-first workflows.
...
## CHECKLIST
- [ ] 9.5.1 Define JSON directive schema (task_id, model_class, allowed_paths, etc.)
- [ ] 9.5.2 Define Worker Receipt schema (touched_files, produced_artifacts, patch_ref, etc.)
- [ ] 9.5.3 Implement patch-first output requirement for tiny models
- [ ] 9.5.4 Define Verifier requirements (allowlist validation, deterministic apply, tests)
