...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/9.6_delegation-harness/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/9.6_delegation-harness/REPORT.md"
...
## GOAL
Execute task **9.6** (Delegation Harness (D.2)) exactly as specified, without scope drift.

## CONTEXT
Build end-to-end fixture-backed test harness for delegation protocol.

## OBJECTIVE
Create production-ready delegation harness with golden delegation job and negative tests.
...
## CHECKLIST
- [ ] 9.6.1 Implement golden delegation job (tiny worker → governor verify → tests)
- [ ] 9.6.2 Add negative test: out-of-scope file touched → FAIL
- [ ] 9.6.3 Add negative test: missing receipt fields → FAIL
- [ ] 9.6.4 Add negative test: non-deterministic ordering → FAIL
