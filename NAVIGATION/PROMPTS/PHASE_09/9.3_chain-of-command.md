...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/9.3_chain-of-command/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/9.3_chain-of-command/REPORT.md"
...
## GOAL
Execute task **9.3** (Chain of Command (Z.6.3)) exactly as specified, without scope drift.

## CONTEXT
Implement escalation, directive, and resolution protocols for swarm hierarchy.

## OBJECTIVE
Create governance chain for agent-to-agent directives and escalation handling.
...
## CHECKLIST
- [ ] 9.3.1 Define escalation protocol schema
- [ ] 9.3.2 Implement directive message format
- [ ] 9.3.3 Build resolution tracking
- [ ] 9.3.4 Add audit logging for chain events
