...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/6.1_cassette-partitioning/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/6.1_cassette-partitioning/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/6.1_cassette-partitioning/REPORT.md
  - Must include:
