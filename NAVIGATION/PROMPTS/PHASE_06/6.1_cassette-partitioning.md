...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/6.1_cassette-partitioning/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/6.1_cassette-partitioning/REPORT.md"
...
## GOAL
Execute task **6.1** (cassette-partitioning) exactly as specified, without scope drift.
...
GOAL
Implement **6.1 Cassette Partitioning (M.1)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/6-1-cassette-partitioning-m-1/  (receipts + report only)
...
title = "6.1 Cassette Partitioning (M.1)"
start = None
...
- Identify the minimal touch set BEFORE editing:
  - `rg -n "6.1" -S .`
  - `rg -n "6.1" -S NAVIGATION/ROADMAPS/AGS_ROADMAP_MASTER_REPHASED_TODO_UPDATED.md`
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/6-1-cassette-partitioning-m-1/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/6-1-cassette-partitioning-m-1/REPORT.md
  - Must include:
...
- receipt_path: LAW/CONTRACTS/_runs/_tmp/prompts/6.1_cassette-partitioning-m-1/receipt.json
- report_path: LAW/CONTRACTS/_runs/_tmp/prompts/6.1_cassette-partitioning-m-1/REPORT.md
