...
phase: 6
task_id: "6.2"
slug: "write-path-memory-persistence"
...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/6.2_write-path-memory-persistence/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/6.2_write-path-memory-persistence/REPORT.md"
...
## GOAL
Execute task **6.2** (write-path-memory-persistence) exactly as specified, without scope drift.
...
GOAL
Implement **6.2 Write Path (Memory Persistence) (M.2)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/6-2-write-path-memory-persistence-m-2/  (receipts + report only)
...
- receipt_path: LAW/CONTRACTS/_runs/_tmp/prompts/6.2_write-path-memory-persistence-m-2/receipt.json
- report_path: LAW/CONTRACTS/_runs/_tmp/prompts/6.2_write-path-memory-persistence-m-2/REPORT.md
