...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/10.2_scale-governance-2/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/10.2_scale-governance-2/REPORT.md"
...
## GOAL
Execute task **10.2** (scale-governance-2) exactly as specified, without scope drift.
...
GOAL
Implement **10.2 Scale & Governance (Ω.2)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/10.2_scale-governance-2/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/10.2_scale-governance-2/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/10.2_scale-governance-2/REPORT.md
  - Must include:
