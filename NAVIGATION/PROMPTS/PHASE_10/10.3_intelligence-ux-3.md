...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/10.3_intelligence-ux-3/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/10.3_intelligence-ux-3/REPORT.md"
...
## GOAL
Execute task **10.3** (intelligence-ux-3) exactly as specified, without scope drift.
...
GOAL
Implement **10.3 Intelligence & UX (Ω.3)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/10.3_intelligence-ux-3/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/10.3_intelligence-ux-3/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/10.3_intelligence-ux-3/REPORT.md
  - Must include:
