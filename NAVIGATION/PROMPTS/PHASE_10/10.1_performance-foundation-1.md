...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/10.1_performance-foundation-1/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/10.1_performance-foundation-1/REPORT.md"
...
## GOAL
Execute task **10.1** (performance-foundation-1) exactly as specified, without scope drift.
...
- Fallback chain: GPT-5.1-Codex-Max -> Claude Sonnet 4.5 (Thinking) -> Gemini 3 Pro (High)

GOAL
Implement **10.1 Performance Foundation (Ω.1)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/10.1_performance-foundation-1/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/10.1_performance-foundation-1/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/10.1_performance-foundation-1/REPORT.md
  - Must include:
