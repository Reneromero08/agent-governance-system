...
phase: 4
task_id: "4.1"
slug: "catalytic-snapshot-restore"
...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/4.1_catalytic-snapshot-restore/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/4.1_catalytic-snapshot-restore/REPORT.md"
...
## GOAL
Execute task **4.1** (catalytic-snapshot-restore) exactly as specified, without scope drift.
...
- Fallback chain: GPT-5.2-Codex -> Claude Opus 4.5 (Thinking) -> Gemini 3 Pro (High)

GOAL
Implement **4.1 Catalytic Snapshot & Restore (Z.4.2–Z.4.4)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/4-1-catalytic-snapshot-restore-z-4-2-z-4-4/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/4-1-catalytic-snapshot-restore-z-4-2-z-4-4/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/4-1-catalytic-snapshot-restore-z-4-2-z-4-4/REPORT.md
  - Must include:
...
- receipt_path: LAW/CONTRACTS/_runs/_tmp/prompts/4.1_catalytic-snapshot-restore-z-4-2-z-4-4/receipt.json
- report_path: LAW/CONTRACTS/_runs/_tmp/prompts/4.1_catalytic-snapshot-restore-z-4-2-z-4-4/REPORT.md
