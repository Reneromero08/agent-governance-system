...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/7.6_search-result-ranking/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/7.6_search-result-ranking/REPORT.md"
...
## GOAL
Execute task **7.6** (search-result-ranking) exactly as specified, without scope drift.
...
GOAL
Implement **7.6 Search Result Ranking (E.5)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/7-6-search-result-ranking-e-5/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/7-6-search-result-ranking-e-5/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/7-6-search-result-ranking-e-5/REPORT.md
  - Must include:
...
- receipt_path: LAW/CONTRACTS/_runs/_tmp/prompts/7.6_search-result-ranking-e-5/receipt.json
- report_path: LAW/CONTRACTS/_runs/_tmp/prompts/7.6_search-result-ranking-e-5/REPORT.md
