...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/7.7_visualization-monitoring/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/7.7_visualization-monitoring/REPORT.md"
...
## GOAL
Execute task **7.7** (visualization-monitoring) exactly as specified, without scope drift.
...
GOAL
Implement **7.7 Visualization & Monitoring (E.6)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/7-7-visualization-monitoring-e-6/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/7-7-visualization-monitoring-e-6/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/7-7-visualization-monitoring-e-6/REPORT.md
  - Must include:
...
- receipt_path: LAW/CONTRACTS/_runs/_tmp/prompts/7.7_visualization-monitoring-e-6/receipt.json
- report_path: LAW/CONTRACTS/_runs/_tmp/prompts/7.7_visualization-monitoring-e-6/REPORT.md
