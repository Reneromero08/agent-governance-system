...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/7.1_research-decisions/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/7.1_research-decisions/REPORT.md"
...
## GOAL
Execute task **7.1** (research-decisions) exactly as specified, without scope drift.
...
GOAL
Implement **7.1 Research Decisions (E.0)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/7-1-research-decisions-e-0/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/7-1-research-decisions-e-0/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/7-1-research-decisions-e-0/REPORT.md
  - Must include:
...
- receipt_path: LAW/CONTRACTS/_runs/_tmp/prompts/7.1_research-decisions-e-0/receipt.json
- report_path: LAW/CONTRACTS/_runs/_tmp/prompts/7.1_research-decisions-e-0/REPORT.md
