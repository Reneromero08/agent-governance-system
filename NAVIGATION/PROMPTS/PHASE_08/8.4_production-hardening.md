...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/8.4_production-hardening/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/8.4_production-hardening/REPORT.md"
...
## GOAL
Execute task **8.4** (production-hardening) exactly as specified, without scope drift.
...
GOAL
Implement **8.4 Production Hardening (R.4)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/8-4-production-hardening-r-4/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/8-4-production-hardening-r-4/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/8-4-production-hardening-r-4/REPORT.md
  - Must include:
...
- receipt_path: LAW/CONTRACTS/_runs/_tmp/prompts/8.4_production-hardening-r-4/receipt.json
- report_path: LAW/CONTRACTS/_runs/_tmp/prompts/8.4_production-hardening-r-4/REPORT.md
