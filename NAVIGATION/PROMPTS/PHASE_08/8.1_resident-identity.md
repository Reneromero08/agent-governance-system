...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/8.1_resident-identity/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/8.1_resident-identity/REPORT.md"
...
## GOAL
Execute task **8.1** (resident-identity) exactly as specified, without scope drift.
...
GOAL
Implement **8.1 Resident Identity (R.1)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/8-1-resident-identity-r-1/  (receipts + report only)
...
title = "8.1 Resident Identity (R.1)"
start = None
...
- Identify the minimal touch set BEFORE editing:
  - `rg -n "8.1" -S .`
  - `rg -n "8.1" -S NAVIGATION/ROADMAPS/AGS_ROADMAP_MASTER_REPHASED_TODO_UPDATED.md`
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/8-1-resident-identity-r-1/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/8-1-resident-identity-r-1/REPORT.md
  - Must include:
...
- receipt_path: LAW/CONTRACTS/_runs/_tmp/prompts/8.1_resident-identity-r-1/receipt.json
- report_path: LAW/CONTRACTS/_runs/_tmp/prompts/8.1_resident-identity-r-1/REPORT.md
