...
GOAL
Implement **8.3 Feral Resident (R.3)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/8-3-feral-resident-r-3/  (receipts + report only)
...
- Identify the minimal touch set BEFORE editing:
  - `rg -n "8.3" -S .`
  - `rg -n "8.3" -S NAVIGATION/ROADMAPS/AGS_ROADMAP_MASTER_REPHASED_TODO_UPDATED.md`
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/8-3-feral-resident-r-3/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/8-3-feral-resident-r-3/REPORT.md
  - Must include:
...
- receipt_path: LAW/CONTRACTS/_runs/_tmp/prompts/8.3_feral-resident-r-3/receipt.json
- report_path: LAW/CONTRACTS/_runs/_tmp/prompts/8.3_feral-resident-r-3/REPORT.md
