...
phase: 8
task_id: "8.2"
slug: "symbol-language-evolution"
...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/8.2_symbol-language-evolution/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/8.2_symbol-language-evolution/REPORT.md"
...
## GOAL
Execute task **8.2** (symbol-language-evolution) exactly as specified, without scope drift.
...
GOAL
Implement **8.2 Symbol Language Evolution (R.2)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/8-2-symbol-language-evolution-r-2/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/8-2-symbol-language-evolution-r-2/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/8-2-symbol-language-evolution-r-2/REPORT.md
  - Must include:
...
- receipt_path: LAW/CONTRACTS/_runs/_tmp/prompts/8.2_symbol-language-evolution-r-2/receipt.json
- report_path: LAW/CONTRACTS/_runs/_tmp/prompts/8.2_symbol-language-evolution-r-2/REPORT.md
