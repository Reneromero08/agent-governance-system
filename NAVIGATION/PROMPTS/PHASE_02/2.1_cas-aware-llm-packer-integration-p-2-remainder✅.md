...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/2.1_cas-aware-llm-packer-integration-p-2-remainder/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/2.1_cas-aware-llm-packer-integration-p-2-remainder/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/2.1_cas-aware-llm-packer-integration-p-2-remainder/REPORT.md
  - Must include:
