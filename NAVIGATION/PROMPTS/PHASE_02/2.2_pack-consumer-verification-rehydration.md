...
phase: 2
task_id: "2.2"
slug: "pack-consumer-verification-rehydration"
...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/2.2_pack-consumer-verification-rehydration/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/2.2_pack-consumer-verification-rehydration/REPORT.md"
...
## GOAL
Execute task **2.2** (pack-consumer-verification-rehydration) exactly as specified, without scope drift.
...
GOAL
Implement **2.2 Pack Consumer (verification + rehydration)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/2.2_pack-consumer-verification-rehydration/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/2.2_pack-consumer-verification-rehydration/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/2.2_pack-consumer-verification-rehydration/REPORT.md
  - Must include:
