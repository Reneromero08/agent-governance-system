...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/2-2-pack-consumer-verification-rehydration/  (receipts + report only)
...
title = "2.2 Pack Consumer (verification + rehydration)"
start = None
...
- Identify the minimal touch set BEFORE editing:
  - `rg -n "2.2" -S .`
  - `rg -n "2.2" -S NAVIGATION/ROADMAPS/AGS_ROADMAP_MASTER_REPHASED_TODO_UPDATED.md`
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/2-2-pack-consumer-verification-rehydration/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/2-2-pack-consumer-verification-rehydration/REPORT.md
  - Must include:
