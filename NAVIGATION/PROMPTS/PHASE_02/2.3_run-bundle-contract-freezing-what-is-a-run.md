...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/2.3_run-bundle-contract-freezing-what-is-a-run/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/2.3_run-bundle-contract-freezing-what-is-a-run/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/2.3_run-bundle-contract-freezing-what-is-a-run/REPORT.md
  - Must include:
