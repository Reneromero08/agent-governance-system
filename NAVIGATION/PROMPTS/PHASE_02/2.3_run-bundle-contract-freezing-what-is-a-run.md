...
phase: 2
task_id: 2.3
slug: run-bundle-contract-freezing-what-is-a-run
legacy_id: P02_2-3
...
receipt_path: LAW/CONTRACTS/_runs/_tmp/prompts/2.3_run-bundle-contract-freezing-what-is-a-run/receipt.json
report_path: LAW/CONTRACTS/_runs/_tmp/prompts/2.3_run-bundle-contract-freezing-what-is-a-run/REPORT.md
...
## GOAL
Execute task **2.3** (run-bundle-contract-freezing-what-is-a-run) exactly as specified, without scope drift.
...
GOAL
Implement **2.3 Run Bundle Contract (freezing “what is a run”)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/2-3-run-bundle-contract-freezing-what-is-a-run/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/2-3-run-bundle-contract-freezing-what-is-a-run/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/2-3-run-bundle-contract-freezing-what-is-a-run/REPORT.md
  - Must include:
...
- [ ] 2.3.2 Implement `run_bundle_create(run_id) -> sha256:`
