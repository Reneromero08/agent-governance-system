...
phase: 1
task_id: 1.3
slug: deprecate-lab-mcp-server-z-1-7
legacy_id: P01_1-3
...
## GOAL
Execute task **1.3** (deprecate-lab-mcp-server-z-1-7) exactly as specified, without scope drift.
...
- Allowed writes (minimal and necessary only):
  - THOUGHT/LAB/MCP/server_CATDPT.py
