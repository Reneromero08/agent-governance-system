...
phase: 1
task_id: "1.1"
slug: "hardened-inbox-governance-s-2"
...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/1.1_hardened-inbox-governance-s-2/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/1.1_hardened-inbox-governance-s-2/REPORT.md"
...
## GOAL
Execute task **1.1** (hardened-inbox-governance-s-2) exactly as specified, without scope drift.
...
GOAL
Implement **1.1 Hardened Inbox Governance (S.2)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  - INBOX/
  - INBOX/*.md
  - SKILLS/inbox-report-writer
  - LAW/CONTRACTS/_runs/_tmp/prompts/1.1_hardened-inbox-governance-s-2/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/1.1_hardened-inbox-governance-s-2/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/1.1_hardened-inbox-governance-s-2/REPORT.md
  - Must include:
