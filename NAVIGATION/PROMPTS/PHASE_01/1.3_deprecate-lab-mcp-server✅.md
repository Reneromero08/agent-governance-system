...
- Allowed writes (minimal and necessary only):
  ...
  - LAW/CONTRACTS/_runs/_tmp/prompts/1.3_deprecate-lab-mcp-server/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/1.3_deprecate-lab-mcp-server/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/1.3_deprecate-lab-mcp-server/REPORT.md
  - Must include:
