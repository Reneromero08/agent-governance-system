...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/1.3_deprecate-lab-mcp-server/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/1.3_deprecate-lab-mcp-server/REPORT.md"
...
## GOAL
Execute task **1.3** (deprecate-lab-mcp-server) exactly as specified, without scope drift.
...
GOAL
Implement **1.3 Deprecate Lab MCP Server (Z.1.7)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  - THOUGHT/LAB/MCP_EXPERIMENTAL/server_CATDPT.py
  - LAW/CONTRACTS/_runs/_tmp/prompts/1-3-deprecate-lab-mcp-server-z-1-7/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/1-3-deprecate-lab-mcp-server-z-1-7/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/1-3-deprecate-lab-mcp-server-z-1-7/REPORT.md
  - Must include:
...
- receipt_path: LAW/CONTRACTS/_runs/_tmp/prompts/1.3_deprecate-lab-mcp-server-z-1-7/receipt.json
- report_path: LAW/CONTRACTS/_runs/_tmp/prompts/1.3_deprecate-lab-mcp-server-z-1-7/REPORT.md
