...
receipt_path: "LAW/CONTRACTS/_runs/_tmp/prompts/1.2_bucket-enforcement-x3/receipt.json"
report_path: "LAW/CONTRACTS/_runs/_tmp/prompts/1.2_bucket-enforcement-x3/REPORT.md"
...
## GOAL
Execute task **1.2** (bucket-enforcement-x3) exactly as specified, without scope drift.
...
GOAL
Implement **1.2 Bucket Enforcement (X3)** by completing its unchecked checklist items from the roadmap. Do not start adjacent sections or “helpful extras”.
...
- Allowed writes (minimal and necessary only):
  - LAW/CONTRACTS/_runs/_tmp/prompts/1.2_bucket-enforcement-x3/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/1.2_bucket-enforcement-x3/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/1.2_bucket-enforcement-x3/REPORT.md
  - Must include:
