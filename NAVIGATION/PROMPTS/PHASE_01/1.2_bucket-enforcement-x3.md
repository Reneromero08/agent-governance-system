...
- Allowed writes (minimal and necessary only):
  - LAW/CONTRACTS/_runs/_tmp/prompts/1-2-bucket-enforcement-x3/  (receipts + report only)
...
- Receipt:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/1-2-bucket-enforcement-x3/receipt.json
  ...
  - Include:
    ...
    - errors: ordered list
- Report:
  - Path: LAW/CONTRACTS/_runs/_tmp/prompts/1-2-bucket-enforcement-x3/REPORT.md
  - Must include:
