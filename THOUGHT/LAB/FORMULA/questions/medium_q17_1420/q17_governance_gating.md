...
**Test file:** `questions/17/test_q17_r_gate.py`
**Results:** `questions/17/q17_test_results.json`
...
**Test output**: `questions/17/q17_test_results.json`
**Implementation**: `questions/17/r_gate.py`
