...
- `questions/8/run_comprehensive_test.py` - Full suite with real embeddings

**Revised tests (CORRECT METHODOLOGY):**
- `questions/8/test_q8_topological_invariance.py` - Rotation/scaling/warping tests
- `questions/8/test_q8_holonomy_revised.py` - Berry phase / PC1-2 holonomy

**Core infrastructure:**
- `questions/8/q8_test_harness.py` - Shared functions (spectral_chern_class, etc.)
- `questions/8/run_q8_tests.py` - Master test runner
