...
## TESTS
1. `questions/6/q6_iit_test.py` - Initial exploration (inconclusive)
2. `questions/6/q6_iit_rigorous_test.py` - **Rigorous proof with continuous synergistic systems**
3. `questions/6/q6_true_iit_phi_test.py` - **TRUE IIT Phi computation with partition analysis**
