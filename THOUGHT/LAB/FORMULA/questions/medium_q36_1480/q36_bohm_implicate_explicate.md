...
- `questions/36/Q36_BOHM_VALIDATION.py` - Test orchestrator
- `questions/36/Q36_VALIDATION_RESULTS.json` - Machine-readable results
- `questions/36/Q36_HARDCORE_TESTS.py` - Additional tests
- `questions/36/Q36_ADDITIONAL_TESTS.py` - Supplementary tests

## References

- Q6: `questions/6/q6_iit_rigorous_test.py`
- Q38: `questions/38/noether.py`
- Q40: `questions/40/`
- Q42: `questions/42/`
- Q43: `questions/43/`
