...
from tier2.l_functions import run_test as run_tier2_1
from tier2.ramanujan_bound import run_test as run_tier2_2
from tier5.trace_formula import run_test as run_tier5_1
