...
**Test file**: `questions/26/q26_scaling_test.py`
...
**Test file**: `questions/26/q26_semantic_structure_test.py`
...
| Test | Path | Purpose |
|------|------|---------|
| Multi-model scaling | `questions/26/q26_scaling_test.py` | 7 models, 7 dimensions |
| Semantic structure | `questions/26/q26_semantic_structure_test.py` | 4 content types |
| Original (deprecated) | `questions/26/test_q26_minimum_data.py` | Underpowered, do not use |
...
*Rigorous retest: 2026-01-27*
*Results: questions/26/q26_scaling_test_results.json*
*Results: questions/26/q26_semantic_structure_results.json*
