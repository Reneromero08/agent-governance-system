...
if __name__ == "__main__":
    ...
    if locality_rate > 0.9 and gluing_rate > 0.9:
        print("\nCONCLUSION: Gate is a SHEAF with R-COVER topology (excellent)")
        print("   Local agreement leads to global consistency.")
    elif monotonicity_rate > 0.5:
        print("\nCONCLUSION: Gate is a SHEAF, but NOT monotone (partial)")
        print("   Local agreement works, but global-to-local fails.")
    else:
        print("\nCONCLUSION: Gate is NOT a good sheaf (weak)")
        print("   Significant violations of sheaf axioms.")
