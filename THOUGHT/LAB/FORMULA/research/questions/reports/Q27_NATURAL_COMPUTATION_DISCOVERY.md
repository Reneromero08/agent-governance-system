...
**Test Scripts**:
- `experiments/open_questions/q27/q27_validation_runner.py` - Statistical validation
- `experiments/open_questions/q27/q27_feral_integration_test.py` - Live system test
- `experiments/open_questions/q27/q27_entropy_filter_test.py` - Hyperbolic fit analysis
...
**Full Technical Report**: `research/questions/lower_priority/q27_hysteresis.md`
