...
### Q48 (Riemann Bridge)
- `experiments/open_questions/q48/test_q48_riemann_bridge.py`
- `experiments/open_questions/q48/test_q48_cumulative_shape.py`
- `experiments/open_questions/q48/test_q48_spectral_zeta.py`
- `experiments/open_questions/q48/test_q48_universal_constant.py`
- `experiments/open_questions/q48/test_q48_qgt_bridge.py`

### Q49 (Why 8e?)
- `experiments/open_questions/q49/test_q49_falsification.py`
- `experiments/open_questions/q49/test_q49_logarithmic_spiral.py`

### Q50 (Riemann Deep Investigation)
- `experiments/open_questions/q50/test_q50_riemann_deep.py` — **α ≈ 1/2 discovery**
- `experiments/open_questions/q50/test_riemann_pi_connection.py` — Tests π at σ_c ≈ 2
- `experiments/open_questions/q50/test_riemann_pi_pattern.py` — **BREAKTHROUGH**: log(ζ)/π = 2s + const
- `experiments/open_questions/q50/test_semantic_primes.py` — Euler product test (NO primes)
- `experiments/open_questions/q50/derive_alpha_half.py` — 6 paths to derive α = 1/2
