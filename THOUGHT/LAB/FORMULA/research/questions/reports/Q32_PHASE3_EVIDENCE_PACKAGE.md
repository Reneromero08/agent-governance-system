...
This is a **Phase 3 evidence index** for Q32. It is **not** a claim that Q32 is fully solved; it is the auditable data trail for the Phase 3 gates defined in `THOUGHT/LAB/FORMULA/research/questions/critical/q32_meaning_as_field.md`.
...
- `THOUGHT/LAB/FORMULA/research/questions/reports/Q32_NEIGHBOR_FALSIFIER_DATA_TRAIL.md`
