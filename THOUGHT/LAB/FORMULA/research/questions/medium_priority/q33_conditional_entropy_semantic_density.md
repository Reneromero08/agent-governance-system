...
- `THOUGHT/LAB/FORMULA/research/questions/critical/q01_why_grad_s.md` — E/∇S derivation
- `THOUGHT/LAB/FORMULA/research/questions/high_priority/q35_markov_blankets.md` — Blanket alignment
