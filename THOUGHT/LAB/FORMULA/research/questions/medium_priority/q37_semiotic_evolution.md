...
### Test Files
- `experiments/open_questions/q37/test_q37_historical.py` - Tier 1 (Diachronic analysis)
- `experiments/open_questions/q37/test_q37_crosslingual.py` - Tier 3 (Cross-lingual)
- `experiments/open_questions/q37/test_q37_phylogeny.py` - Tier 4 (Phylogenetic reconstruction)
- `experiments/open_questions/q37/test_q37_conservation.py` - Tier 9 (Conservation persistence)
- `experiments/open_questions/q37/test_q37_multimodel.py` - Tier 10 (Multi-model universality)
- `experiments/open_questions/q37/run_all_q37_tests.py` - Aggregated runner
