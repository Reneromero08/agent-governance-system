...
## TESTS
- `open_questions/q6/q6_free_energy_test.py` - R vs F correlation, gating efficiency
- `open_questions/q1/q1_derivation_test.py` - **Test 4: Family-scoped equivalence (Gaussian AND Laplace)**
