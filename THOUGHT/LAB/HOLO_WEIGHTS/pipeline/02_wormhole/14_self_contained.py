...
if __name__ == "__main__":
    ...
    model_dirs = [
        _paths.REPO / "THOUGHT/LAB/CAT_CAS/3_physics_complexity/16_catalytic_27b_inference/gemini_update/qwen_27b",
        _paths.REPO / "THOUGHT/LAB/CAT_CAS/3_physics_complexity/16_catalytic_27b_inference/gemini_update/qwen_0.5b",
