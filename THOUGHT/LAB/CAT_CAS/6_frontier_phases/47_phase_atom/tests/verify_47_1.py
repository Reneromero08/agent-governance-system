...
EXP_FILE = os.path.join(EXP_DIR, '47_1_nucleus_memory_knot', '47_1_nucleus_memory_knot.py')
sys.path.insert(0, os.path.join(EXP_DIR, '47_1_nucleus_memory_knot'))
...
try:
    with contextlib.redirect_stdout(output_buf):
        old_cwd = os.getcwd()
        os.chdir(os.path.join(EXP_DIR, '47_1_nucleus_memory_knot'))
