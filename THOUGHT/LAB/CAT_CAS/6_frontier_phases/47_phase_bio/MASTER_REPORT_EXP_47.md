...
**Key files**: `47_1_protein_folding/47_1_protein_folding_oracle.py`, `validation_real_pdb.py`
...
**Key files**: `47_3_prion_contagion/47_3_prion_contagion_oracle.py`
...
**Key files**: `47_5_neural_binding_oracle/47_5_neural_binding_oracle.py`, `validation_real_connectome.py`
...
**Key files**: `47_6_morphogenesis_oracle/47_6_morphogenesis_oracle.py`, `validation_real_morphogenesis.py`
