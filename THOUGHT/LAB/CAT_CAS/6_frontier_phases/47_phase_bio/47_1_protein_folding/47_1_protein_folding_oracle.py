# DEPRECATED (2026-06-01): Replaced by 47_1_foldability_oracle.py
...
# See: 47_1_foldability_oracle.py for the canonical verified implementation.
...
def run_experiment():
    ...
    with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), "TELEMETRY_47_1.txt"), "w") as f:
        f.write("\n".join(output_lines) + "\n")
