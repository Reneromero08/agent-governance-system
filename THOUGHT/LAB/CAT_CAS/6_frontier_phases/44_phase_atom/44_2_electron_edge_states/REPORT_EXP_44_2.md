...
We implemented `44_2_electron_edge_states.py` as a non-Hermitian tight-binding lattice:
...
*   **Location:** The execution and telemetry reside permanently in `THOUGHT/LAB/CAT_CAS/6_frontier_phases/44_phase_atom/44_2_electron_edge_states/`.
