...
EXP_FILE = os.path.join(EXP_DIR, '44_4_lhc_overflow_exploit', '44_4_lhc_overflow_exploit.py')
sys.path.insert(0, os.path.join(EXP_DIR, '44_4_lhc_overflow_exploit'))
...
try:
    with contextlib.redirect_stdout(output_buf):
        old_cwd = os.getcwd()
        os.chdir(os.path.join(EXP_DIR, '44_4_lhc_overflow_exploit'))
