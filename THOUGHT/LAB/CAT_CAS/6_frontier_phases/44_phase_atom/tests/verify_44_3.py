...
EXP_FILE = os.path.join(EXP_DIR, '44_3_pauli_exclusion', '44_3_pauli_exclusion.py')
sys.path.insert(0, os.path.join(EXP_DIR, '44_3_pauli_exclusion'))
...
try:
    with contextlib.redirect_stdout(output_buf):
        old_cwd = os.getcwd()
        os.chdir(os.path.join(EXP_DIR, '44_3_pauli_exclusion'))
