...
EXP_FILE = os.path.join(EXP_DIR, '44_5_higgs_mechanism', '44_5_higgs_mechanism.py')
sys.path.insert(0, os.path.join(EXP_DIR, '44_5_higgs_mechanism'))
...
try:
    with contextlib.redirect_stdout(output_buf):
        old_cwd = os.getcwd()
        os.chdir(os.path.join(EXP_DIR, '44_5_higgs_mechanism'))
