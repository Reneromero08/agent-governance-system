...
EXP_FILE = os.path.join(EXP_DIR, '44_6_quark_confinement', '44_6_quark_confinement.py')
sys.path.insert(0, os.path.join(EXP_DIR, '44_6_quark_confinement'))
...
try:
    with contextlib.redirect_stdout(output_buf):
        old_cwd = os.getcwd()
        os.chdir(os.path.join(EXP_DIR, '44_6_quark_confinement'))
