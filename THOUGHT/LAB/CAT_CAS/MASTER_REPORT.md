...
This matrix is the missing part of the previous master report. It covers every major experiment/phase found in the ZIP/README: 01-49, plus Exp 50 (phase_bm_cpu, at 7_decoder/50_phase_bm_cpu).
...
| 50 | Phase BM CPU / Bare-Metal CPU Substrate Push | `7_decoder/50_phase_bm_cpu/` | INFRASTRUCTURE / ACTIVE | Physical substrate push — the attempt to cross the located lattice wall on real silicon, handed off from Exp 49 Phase 6. | Bare-metal lab host/network setup + active substrate experiment. | 7_decoder/50_phase_bm_cpu/REPORT.md |
...
- **Evidence / source docs:** 7_decoder/50_phase_bm_cpu/REPORT.md, in-tree phase reports
- **Audit note:** Placed at `7_decoder/50_phase_bm_cpu`. Number 44 belongs solely to Exp 44 Phase Atom (in 6_frontier_phases/); the prior transient collision is resolved. See CONVENTIONS.md section 10.
...
Experiments 43 (math) and 45-48 (energy, chem, bio, consciousness) are mixed or roadmap-only phases. Exp 49 (decoder) is closed out at theory terminus. Exp 50 (bm_cpu) is active bare-metal infrastructure + physical wall-crossing attempt, at `7_decoder/50_phase_bm_cpu`. The frontier arc runs: limits (42 event-horizon) -> proof-power (43 math) -> emergence built atom-up (44 atom -> 45 energy -> 46 chem -> 47 bio -> 48 consciousness, final boss) -> the wall (49 decoder theory + 50 bm_cpu physical crossing). Experiments 45, 46, and 48 should not be counted as completed experiments yet.
