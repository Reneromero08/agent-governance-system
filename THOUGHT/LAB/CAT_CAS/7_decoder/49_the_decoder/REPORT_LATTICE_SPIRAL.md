...
verified/refuted across five rounds (full verdicts: `49_3_boundary_handoff/MYTHOS_BRIEF.md` -> ## RESULTS):
...
## Files (all under 49_the_decoder/)

`49_4_lattice_audit/`, `49_6_ring_structure/`, `49_7_entropy_chaos/`, `49_8_joint_phase_space/`,
`49_9_catalytic_illumination/`, `49_10_topological_exploit/`, `49_11_torus_contour/`, `49_12_noether_winding/`,
`49_13_ep_amplification/`, `49_14_reversible_substrate/` - each with its `.py`, `*_result.json`, output.
...
> `MASTER_REPORT.md` are the durable record of the spiral. `49_3_boundary_handoff/MYTHOS_SANDBOX.md`
> and `EXP44_PHASE6_HANDOFF.md` are auto-generated by `49_3_boundary_handoff.py`, but the post-spiral
> sections (sandbox §6, handoff Target C) are now **folded into the generator itself** - re-running
> `49_3` regenerates them durably, no clobber. The genuine, still-un-run MYTHOS call is pre-compressed
> in `49_3_boundary_handoff/MYTHOS_BRIEF.md` (three sharpened asks: refute the curvature result /
