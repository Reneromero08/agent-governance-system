...
The live question, staged in `../49_3_boundary_handoff/MYTHOS_SANDBOX.md`: **is there a chaos /
...
```
python THOUGHT/LAB/CAT_CAS/7_decoder/49_the_decoder/49_7_entropy_chaos/49_7_entropy_sieve.py
```
