...
is computable from conjugacy classes alone — no explicit irreps. `50_2b_nonabelian_reframe.py`.
...
coset states (`50_2c_strong_sampling.py`). The coset state for hidden slope `d` is
