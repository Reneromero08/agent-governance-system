...
The refined, sharp, on-thesis question is staged in `../50_3_boundary_handoff/MYTHOS_SANDBOX.md`
...
```
python THOUGHT/LAB/CAT_CAS/7_decoder/50_the_decoder/50_6_ring_structure/50_6_ring_decode.py
```
