...
```
python 50_1_extractive_proof/50_1_extractive_proof.py        -> exit 0  (5/5 gates)
python 50_2_decodability_gradient/50_2_decodability_gradient.py -> exit 0  (5/5 gates)
python 50_2_decodability_gradient/50_2b_nonabelian_reframe.py -> exit 0  (3/3; wall relocated to strong sampling)
python 50_2_decodability_gradient/50_2c_strong_sampling.py    -> exit 0  (3/3; residual wall = lattice barrier)
python 50_2_decodability_gradient/50_2_anchor_cospectral.py   -> exit 0  (spectrum-bounded confirmed)
python 50_3_boundary_handoff/50_3_boundary_handoff.py         -> exit 0  (handoffs emitted, non-placeholder)
python CAPABILITY/TOOLS/governance/critic.py                  -> 0 violations containing "50_the_decoder"
```
