...
def main():
    ...
    if core_pass and strict_area_pass and freq_proven and artifact_clean:
        ...
        verdict = 'EXP50_PHASE5_8_SILICON_BOUNDARY_CONFIRMED'
    elif g1 == 'PASS' and g2 == 'PASS' and g3 == 'PASS' and g7 == 'PASS':
        verdict = 'EXP50_PHASE5_8_DIGITAL_TO_SILICON_TRANSITION_CONFIRMED'
    elif load_deforms:
        verdict = 'EXP50_PHASE5_8_PARTIAL_BOUNDARY_DEFORMATION'
    elif not artifact_ok:
        verdict = 'EXP50_PHASE5_8_ARTIFACT_DOMINANT'
    else:
        verdict = 'EXP50_PHASE5_8_NOISE_ONLY'
    ...
    # Print summary
    print("=" * 60)
    print("EXP50 PHASE 5.8R: CROSS-RUN MASTER VERDICT")
    print("=" * 60)
    for gate, result in sorted(gates.items()):
        if not gate.endswith('_reason'):
