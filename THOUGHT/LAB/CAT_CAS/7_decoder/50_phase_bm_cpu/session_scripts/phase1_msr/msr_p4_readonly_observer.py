#!/usr/bin/env python3
"""
Read-only P-state/MSR observer for Exp50.
...
def main():
    parser = argparse.ArgumentParser(description="Read-only Exp50 P4/MSR observer")
    ...
    print("=== Exp50 read-only P4/MSR observer ===")
