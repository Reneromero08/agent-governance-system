...
def main():
    ...
    print("=" * 60)
    print("EXP50 PHASE 5.9C: CROSS-RUN MASTER VERDICT")
    print("=" * 60)
    ...
    if edge_reached:
        ...
        final_verdict = 'EXP50_PHASE5_9C_EDGE_APPROACHED'
    elif platform_hard:
        gates['9_Final_Classification'] = 'PLATFORM_HARD_BOUNDARY'
        final_verdict = 'EXP50_PHASE5_9C_PLATFORM_HARD_BOUNDARY'
    else:
        gates['9_Final_Classification'] = 'INSTABILITY_EDGE_NOT_REACHED'
        final_verdict = 'EXP50_PHASE5_9C_INSTABILITY_EDGE_NOT_REACHED'
