...
typedef enum relation_spatial_control_id {
    ...
    RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_ALIVE_R0R1_PRIMARY = 41,
    RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_ALIVE_R0R1_SHAM = 42,
    RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_ALIVE_R1R0_PRIMARY = 43,
    RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_ALIVE_R1R0_SHAM = 44,
    RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_SOURCE_OFF_R0R1_PRIMARY = 45,
    RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_SOURCE_OFF_R0R1_SHAM = 46,
    RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_SOURCE_OFF_R1R0_PRIMARY = 47,
    RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_SOURCE_OFF_R1R0_SHAM = 48,
    RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_DEAD_R0R1_PRIMARY = 49,
    RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_DEAD_R0R1_SHAM = 50,
    RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_DEAD_R1R0_PRIMARY = 51,
    RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_DEAD_R1R0_SHAM = 52,
    RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_ALIVE_R0R1_PRIMARY = 53,
    RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_ALIVE_R0R1_SHAM = 54,
    RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_ALIVE_R1R0_PRIMARY = 55,
    RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_ALIVE_R1R0_SHAM = 56,
    RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_SOURCE_OFF_R0R1_PRIMARY = 57,
    RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_SOURCE_OFF_R0R1_SHAM = 58,
    RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_SOURCE_OFF_R1R0_PRIMARY = 59,
    RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_SOURCE_OFF_R1R0_SHAM = 60,
    RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_DEAD_R0R1_PRIMARY = 61,
    RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_DEAD_R0R1_SHAM = 62,
    RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_DEAD_R1R0_PRIMARY = 63,
    RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_DEAD_R1R0_SHAM = 64
