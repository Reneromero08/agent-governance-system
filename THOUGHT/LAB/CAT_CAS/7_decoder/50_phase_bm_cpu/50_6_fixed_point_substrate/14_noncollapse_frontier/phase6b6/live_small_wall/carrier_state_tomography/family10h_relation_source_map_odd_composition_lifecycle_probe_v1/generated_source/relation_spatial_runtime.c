...
static int parse_control(const char *query, relation_spatial_control_id *out) {
    ...
    if (strcmp(query, "mop_n_alv_r0r1_p_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_ALIVE_R0R1_PRIMARY;
        return 1;
    }
    if (strcmp(query, "mop_n_alv_r0r1_h_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_ALIVE_R0R1_SHAM;
        return 1;
    }
    if (strcmp(query, "mop_n_alv_r1r0_p_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_ALIVE_R1R0_PRIMARY;
        return 1;
    }
    if (strcmp(query, "mop_n_alv_r1r0_h_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_ALIVE_R1R0_SHAM;
        return 1;
    }
    if (strcmp(query, "mop_n_off_r0r1_p_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_SOURCE_OFF_R0R1_PRIMARY;
        return 1;
    }
    if (strcmp(query, "mop_n_off_r0r1_h_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_SOURCE_OFF_R0R1_SHAM;
        return 1;
    }
    if (strcmp(query, "mop_n_off_r1r0_p_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_SOURCE_OFF_R1R0_PRIMARY;
        return 1;
    }
    if (strcmp(query, "mop_n_off_r1r0_h_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_SOURCE_OFF_R1R0_SHAM;
        return 1;
    }
    if (strcmp(query, "mop_n_ded_r0r1_p_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_DEAD_R0R1_PRIMARY;
        return 1;
    }
    if (strcmp(query, "mop_n_ded_r0r1_h_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_DEAD_R0R1_SHAM;
        return 1;
    }
    if (strcmp(query, "mop_n_ded_r1r0_p_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_DEAD_R1R0_PRIMARY;
        return 1;
    }
    if (strcmp(query, "mop_n_ded_r1r0_h_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_DEAD_R1R0_SHAM;
        return 1;
    }
    if (strcmp(query, "mop_s_alv_r0r1_p_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_ALIVE_R0R1_PRIMARY;
        return 1;
    }
    if (strcmp(query, "mop_s_alv_r0r1_h_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_ALIVE_R0R1_SHAM;
        return 1;
    }
    if (strcmp(query, "mop_s_alv_r1r0_p_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_ALIVE_R1R0_PRIMARY;
        return 1;
    }
    if (strcmp(query, "mop_s_alv_r1r0_h_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_ALIVE_R1R0_SHAM;
        return 1;
    }
    if (strcmp(query, "mop_s_off_r0r1_p_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_SOURCE_OFF_R0R1_PRIMARY;
        return 1;
    }
    if (strcmp(query, "mop_s_off_r0r1_h_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_SOURCE_OFF_R0R1_SHAM;
        return 1;
    }
    if (strcmp(query, "mop_s_off_r1r0_p_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_SOURCE_OFF_R1R0_PRIMARY;
        return 1;
    }
    if (strcmp(query, "mop_s_off_r1r0_h_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_SOURCE_OFF_R1R0_SHAM;
        return 1;
    }
    if (strcmp(query, "mop_s_ded_r0r1_p_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_DEAD_R0R1_PRIMARY;
        return 1;
    }
    if (strcmp(query, "mop_s_ded_r0r1_h_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_DEAD_R0R1_SHAM;
        return 1;
    }
    if (strcmp(query, "mop_s_ded_r1r0_p_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_DEAD_R1R0_PRIMARY;
        return 1;
    }
    if (strcmp(query, "mop_s_ded_r1r0_h_control") == 0) {
        *out = RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_DEAD_R1R0_SHAM;
        return 1;
    }
    return 0;
}
...
static uint32_t control_b_index(const relation_spatial_schedule_row *row, uint32_t a_index, uint32_t sample_index) {
    ...
    if (row->control == RELATION_SPATIAL_CONTROL_DEAD_SHAM
        ...
        || row->control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_ALIVE_R0R1_SHAM
        || row->control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_ALIVE_R1R0_SHAM
        || row->control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_SOURCE_OFF_R0R1_SHAM
        || row->control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_SOURCE_OFF_R1R0_SHAM
        || row->control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_DEAD_R0R1_SHAM
        || row->control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_DEAD_R1R0_SHAM
        || row->control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_ALIVE_R0R1_SHAM
        || row->control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_ALIVE_R1R0_SHAM
        || row->control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_SOURCE_OFF_R0R1_SHAM
        || row->control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_SOURCE_OFF_R1R0_SHAM
        || row->control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_DEAD_R0R1_SHAM
        || row->control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_DEAD_R1R0_SHAM) {
        return (a_index + 1024u + ((uint32_t)row->execution_ordinal & 31u)) % FAMILY10H_RELATION_SPATIAL_LINE_COUNT;
    }
...
static int source_dead_before_query_control(relation_spatial_control_id control) {
    return control == RELATION_SPATIAL_CONTROL_DEAD_PRIMARY
        ...
        || control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_SOURCE_OFF_R0R1_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_SOURCE_OFF_R0R1_SHAM
        || control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_SOURCE_OFF_R1R0_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_SOURCE_OFF_R1R0_SHAM
        || control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_DEAD_R0R1_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_DEAD_R0R1_SHAM
        || control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_DEAD_R1R0_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_DEAD_R1R0_SHAM
        || control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_SOURCE_OFF_R0R1_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_SOURCE_OFF_R0R1_SHAM
        || control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_SOURCE_OFF_R1R0_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_SOURCE_OFF_R1R0_SHAM
        || control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_DEAD_R0R1_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_DEAD_R0R1_SHAM
        || control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_DEAD_R1R0_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_DEAD_R1R0_SHAM;
}
...
static int mapodd_native_r0_r1_control(relation_spatial_control_id control) {
    return control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_ALIVE_R0R1_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_ALIVE_R0R1_SHAM
        || control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_SOURCE_OFF_R0R1_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_SOURCE_OFF_R0R1_SHAM
        || control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_DEAD_R0R1_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_DEAD_R0R1_SHAM;
...
static int mapodd_native_r1_r0_control(relation_spatial_control_id control) {
    return control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_ALIVE_R1R0_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_ALIVE_R1R0_SHAM
        || control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_SOURCE_OFF_R1R0_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_SOURCE_OFF_R1R0_SHAM
        || control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_DEAD_R1R0_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_NATIVE_DEAD_R1R0_SHAM;
...
static int mapodd_swapped_r0_r1_control(relation_spatial_control_id control) {
    return control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_ALIVE_R0R1_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_ALIVE_R0R1_SHAM
        || control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_SOURCE_OFF_R0R1_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_SOURCE_OFF_R0R1_SHAM
        || control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_DEAD_R0R1_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_DEAD_R0R1_SHAM;
...
static int mapodd_swapped_r1_r0_control(relation_spatial_control_id control) {
    return control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_ALIVE_R1R0_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_ALIVE_R1R0_SHAM
        || control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_SOURCE_OFF_R1R0_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_SOURCE_OFF_R1R0_SHAM
        || control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_DEAD_R1R0_PRIMARY
        || control == RELATION_SPATIAL_CONTROL_MAPODD_SWAPPED_DEAD_R1R0_SHAM;
