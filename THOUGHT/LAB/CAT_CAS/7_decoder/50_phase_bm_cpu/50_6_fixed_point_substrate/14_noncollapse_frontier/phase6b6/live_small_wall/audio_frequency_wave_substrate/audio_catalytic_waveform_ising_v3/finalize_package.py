...
PREORACLE_SEAL_FILE = PACKAGE_DIR / "V3_PREORACLE_SEAL.json"
RESULTS_FILE = PACKAGE_DIR / "V3_BATCH_RESULTS.json"
INDEPENDENT_FILE = PACKAGE_DIR / "V3_INDEPENDENT_VERIFICATION.json"
STATE_FILE = PACKAGE_DIR / "V3_LANE_STATE.md"
MANIFEST_FILE = PACKAGE_DIR / "V3_FINAL_MANIFEST.json"

DECISION = "CATALYTIC_WAVEFORM_ISING_V3_VERIFIED"
CLAIM_CEILING = "BOUNDED_SOFTWARE_RECURSIVE_SPECTRAL_PHASE_REFERENCE_ONLY"
FINAL_FILES = (
    "V3_BATCH_REPORT.md",
    "V3_BATCH_RESULTS.json",
    "V3_INDEPENDENT_REVIEW.md",
    "V3_INDEPENDENT_VERIFICATION.json",
    "V3_ORACLE_TRACE.json",
    "finalize_package.py",
...
def state_bytes(
    ...
    text = f"""# Catalytic Waveform-Ising V3 Lane State
...
def manifest_document() -> dict[str, Any]:
    ...
    return {
        ...
        "schema": "catalytic_waveform_ising_v3_final_manifest_v1",
    }
