...
typedef enum relation_spatial_control_id {
    ...
    RELATION_SPATIAL_CONTROL_PALINDROME_A_PRIMARY = 45,
    RELATION_SPATIAL_CONTROL_PALINDROME_A_SHAM = 46,
    RELATION_SPATIAL_CONTROL_PALINDROME_B_PRIMARY = 47,
    RELATION_SPATIAL_CONTROL_PALINDROME_B_SHAM = 48,
    RELATION_SPATIAL_CONTROL_DEAD_PALINDROME_A_PRIMARY = 49,
    RELATION_SPATIAL_CONTROL_DEAD_PALINDROME_A_SHAM = 50,
    RELATION_SPATIAL_CONTROL_DEAD_PALINDROME_B_PRIMARY = 51,
    RELATION_SPATIAL_CONTROL_DEAD_PALINDROME_B_SHAM = 52,
    RELATION_SPATIAL_CONTROL_SOURCE_OFF_PALINDROME_A_PRIMARY = 53,
    RELATION_SPATIAL_CONTROL_SOURCE_OFF_PALINDROME_A_SHAM = 54,
    RELATION_SPATIAL_CONTROL_SOURCE_OFF_PALINDROME_B_PRIMARY = 55,
    RELATION_SPATIAL_CONTROL_SOURCE_OFF_PALINDROME_B_SHAM = 56,
    ...
    RELATION_SPATIAL_CONTROL_DEAD_BLOCK_REPLAY_A_PRIMARY = 61,
    RELATION_SPATIAL_CONTROL_DEAD_BLOCK_REPLAY_A_SHAM = 62,
    RELATION_SPATIAL_CONTROL_DEAD_BLOCK_REPLAY_B_PRIMARY = 63,
    RELATION_SPATIAL_CONTROL_DEAD_BLOCK_REPLAY_B_SHAM = 64,
    RELATION_SPATIAL_CONTROL_SOURCE_OFF_BLOCK_REPLAY_A_PRIMARY = 65,
    RELATION_SPATIAL_CONTROL_SOURCE_OFF_BLOCK_REPLAY_A_SHAM = 66,
    RELATION_SPATIAL_CONTROL_SOURCE_OFF_BLOCK_REPLAY_B_PRIMARY = 67,
    RELATION_SPATIAL_CONTROL_SOURCE_OFF_BLOCK_REPLAY_B_SHAM = 68
