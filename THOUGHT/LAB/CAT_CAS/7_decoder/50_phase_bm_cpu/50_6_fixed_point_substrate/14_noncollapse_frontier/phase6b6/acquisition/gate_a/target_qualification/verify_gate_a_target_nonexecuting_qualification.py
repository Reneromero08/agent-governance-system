...
def validate_evidence(result: dict[str, Any]) -> dict[str, Any]:
    ...
    return {"final_bindings": final_bindings, "copy_back": cb, "cleanup": cl, "qualification": qjson,
...
def mutation_tests(result: dict[str, Any], auth: dict[str, Any], cand: dict[str, Any], qjson: dict[str, Any]) -> dict[str, Any]:
    cases: list[str] = []
...
def main() -> int:
    ...
    mutations = mutation_tests(result, auth, cand, evidence["qualification"])
