#!/usr/bin/env python3
"""Install the Phase-QEMU V1 device into an unpacked QEMU 10.2 source tree."""
...
MESON_LINE = (
    "system_ss.add(when: 'CONFIG_PHASE_QEMU_V1', "
    "if_true: files('phase-qemu-v1.c'))\n"
)
...
def main() -> int:
    ...
    device_source = package / "qemu" / "hw" / "misc" / "phase-qemu-v1.c"
    target_source = source / "hw" / "misc" / "phase-qemu-v1.c"
