#!/usr/bin/env python3
"""Synthetic fixture helper for relation-lifetime offline tests.

This module deliberately emits only synthetic result classes. The physical
prospective law lives in relation_lifetime_physical_adjudication.py.
"""
...
def fixture_packet(schedule: dict[str, Any], mode: str) -> dict[str, Any]:
    ...
    return {"schema": "SYNTHETIC_RELATION_LIFETIME_FIXTURE_PACKET_V2", "mode": mode, "raw_records": rows}
...
def run_adversary_tests(schedule: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "schema": "FAMILY10H_RELATION_LIFETIME_ADVERSARY_TEST_V2",
        "thresholds": {
