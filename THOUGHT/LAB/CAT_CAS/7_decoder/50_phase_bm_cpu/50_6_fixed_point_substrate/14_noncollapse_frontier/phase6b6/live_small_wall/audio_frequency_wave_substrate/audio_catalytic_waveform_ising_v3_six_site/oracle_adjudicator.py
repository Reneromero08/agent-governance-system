...
EVIDENCE_FILE = PACKAGE_DIR / "SIX_SITE_PREORACLE_EVIDENCE.json"
TRACE_FILE = PACKAGE_DIR / "SIX_SITE_PREORACLE_TRACE.json"
SEAL_FILE = PACKAGE_DIR / "SIX_SITE_PREORACLE_SEAL.json"
CONTROL_RESULTS = PACKAGE_DIR / "CONTROL_RESULTS.json"
RESULT_FILE = PACKAGE_DIR / "SIX_SITE_BATCH_RESULTS.json"
ORACLE_TRACE_FILE = PACKAGE_DIR / "SIX_SITE_ORACLE_TRACE.json"
REPORT_FILE = PACKAGE_DIR / "SIX_SITE_BATCH_REPORT.md"

VERIFIED = "CATALYTIC_WAVEFORM_ISING_V3_SIX_SITE_VERIFIED"
PARTIAL = "CATALYTIC_WAVEFORM_ISING_V3_SIX_SITE_PARTIAL"
NOT_ESTABLISHED = "CATALYTIC_WAVEFORM_ISING_V3_SIX_SITE_NOT_ESTABLISHED"
...
machine = load_module(MACHINE_SOURCE, "catcas_waveform_ising_v3_six_site_oracle_machine")
...
class EventLedger:
    ...
    def document(self) -> dict[str, Any]:
        return {
            ...
            "schema": "catalytic_waveform_ising_v3_six_site_oracle_trace_v1",
        }
...
def build_documents(
    ...
    results = {
        ...
        "schema": "catalytic_waveform_ising_v3_six_site_batch_results_v1",
        "summary": summary,
    }
...
def report_bytes(results: dict[str, Any], trace: dict[str, Any]) -> bytes:
    ...
    lines = [
        "# Catalytic Waveform-Ising V3 Six-Site Prospective Result",
        "",
        ...
        "",
        "The result is a bounded 64-mode software spectral reference. It establishes",
