...
RUN_ID = "family10h_relation_loop_transport_source_off_screen_discovery_v1_0"
...
VARIANTS = [
    ...
    "loop_r1r0_primary",
    "loop_r1r0_sham",
    "dead_loop_r0r1_primary",
    "dead_loop_r0r1_sham",
    "dead_loop_r1r0_primary",
    "dead_loop_r1r0_sham",
    "source_off_loop_r0r1_primary",
    "source_off_loop_r0r1_sham",
    "source_off_loop_r1r0_primary",
    "source_off_loop_r1r0_sham",
    "gapped_loop_r0r1_primary",
    "gapped_loop_r0r1_sham",
    "gapped_loop_r1r0_primary",
    "gapped_loop_r1r0_sham",
]
QUERY_BY_VARIANT = {
    "loop_r0r1_primary": "loop_r0_then_r1_query_relation_pair_control",
    "loop_r0r1_sham": "loop_r0_then_r1_relation_sham_control",
    "loop_r1r0_primary": "loop_r1_then_r0_query_relation_pair_control",
    "loop_r1r0_sham": "loop_r1_then_r0_relation_sham_control",
    "dead_loop_r0r1_primary": "dead_loop_r0_then_r1_query_relation_pair_control",
    "dead_loop_r0r1_sham": "dead_loop_r0_then_r1_relation_sham_control",
    "dead_loop_r1r0_primary": "dead_loop_r1_then_r0_query_relation_pair_control",
    "dead_loop_r1r0_sham": "dead_loop_r1_then_r0_relation_sham_control",
    "source_off_loop_r0r1_primary": "source_off_loop_r0_then_r1_query_relation_pair_control",
    "source_off_loop_r0r1_sham": "source_off_loop_r0_then_r1_relation_sham_control",
    "source_off_loop_r1r0_primary": "source_off_loop_r1_then_r0_query_relation_pair_control",
    "source_off_loop_r1r0_sham": "source_off_loop_r1_then_r0_relation_sham_control",
    "gapped_loop_r0r1_primary": "gapped_loop_r0_then_r1_query_relation_pair_control",
    "gapped_loop_r0r1_sham": "gapped_loop_r0_then_r1_relation_sham_control",
    "gapped_loop_r1r0_primary": "gapped_loop_r1_then_r0_query_relation_pair_control",
    "gapped_loop_r1r0_sham": "gapped_loop_r1_then_r0_relation_sham_control",
}
...
MATCHED_PERMUTATION_SEED = "family10h-relation-loop-transport-source-off-screen-discovery-v1"
...
SCHEDULE_DIR = SOURCE_ROOT / "RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_SCHEDULES"
...
SUMMARY_JSON = HERE / "RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_DISCOVERY_SUMMARY.json"
SUMMARY_MD = HERE / "RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_DISCOVERY_SUMMARY.md"
...
def patch_runtime_for_rspatial_full_schedule_lifetime_reset() -> None:
    ...
    text = text.replace(
        ...
        "    RELATION_SPATIAL_CONTROL_SOURCE_OFF_PRIMARY = 15,\n"
        "    RELATION_SPATIAL_CONTROL_SOURCE_OFF_SHAM = 16,\n"
        "    RELATION_SPATIAL_CONTROL_LOOP_R0_R1_PRIMARY = 17,\n"
        "    RELATION_SPATIAL_CONTROL_LOOP_R0_R1_SHAM = 18,\n"
        "    RELATION_SPATIAL_CONTROL_LOOP_R1_R0_PRIMARY = 19,\n"
        "    RELATION_SPATIAL_CONTROL_LOOP_R1_R0_SHAM = 20,\n"
        "    RELATION_SPATIAL_CONTROL_DEAD_LOOP_R0_R1_PRIMARY = 21,\n"
        "    RELATION_SPATIAL_CONTROL_DEAD_LOOP_R0_R1_SHAM = 22,\n"
        "    RELATION_SPATIAL_CONTROL_DEAD_LOOP_R1_R0_PRIMARY = 23,\n"
        "    RELATION_SPATIAL_CONTROL_DEAD_LOOP_R1_R0_SHAM = 24,\n"
        "    RELATION_SPATIAL_CONTROL_SOURCE_OFF_LOOP_R0_R1_PRIMARY = 25,\n"
        "    RELATION_SPATIAL_CONTROL_SOURCE_OFF_LOOP_R0_R1_SHAM = 26,\n"
        "    RELATION_SPATIAL_CONTROL_SOURCE_OFF_LOOP_R1_R0_PRIMARY = 27,\n"
        "    RELATION_SPATIAL_CONTROL_SOURCE_OFF_LOOP_R1_R0_SHAM = 28,\n"
        "    RELATION_SPATIAL_CONTROL_GAPPED_LOOP_R0_R1_PRIMARY = 29,\n"
        "    RELATION_SPATIAL_CONTROL_GAPPED_LOOP_R0_R1_SHAM = 30,\n"
        "    RELATION_SPATIAL_CONTROL_GAPPED_LOOP_R1_R0_PRIMARY = 31,\n"
        "    RELATION_SPATIAL_CONTROL_GAPPED_LOOP_R1_R0_SHAM = 32",
    )
    ...
    text = text.replace(
        ...
        "        return 1;\n"
        "    }\n"
        '    if (strcmp(query, "source_off_query_relation_pair_control") == 0) {\n'
        "        *out = RELATION_SPATIAL_CONTROL_SOURCE_OFF_PRIMARY;\n"
        "        return 1;\n"
        "    }\n"
        ...
        "        return 1;\n"
        "    }\n"
        '    if (strcmp(query, "loop_r0_then_r1_query_relation_pair_control") == 0) {\n'
        "        *out = RELATION_SPATIAL_CONTROL_LOOP_R0_R1_PRIMARY;\n"
        "        return 1;\n"
        "    }\n"
        '    if (strcmp(query, "loop_r0_then_r1_relation_sham_control") == 0) {\n'
        "        *out = RELATION_SPATIAL_CONTROL_LOOP_R0_R1_SHAM;\n"
        "        return 1;\n"
        "    }\n"
        '    if (strcmp(query, "loop_r1_then_r0_query_relation_pair_control") == 0) {\n'
        "        *out = RELATION_SPATIAL_CONTROL_LOOP_R1_R0_PRIMARY;\n"
        "        return 1;\n"
        "    }\n"
        '    if (strcmp(query, "loop_r1_then_r0_relation_sham_control") == 0) {\n'
        "        *out = RELATION_SPATIAL_CONTROL_LOOP_R1_R0_SHAM;\n"
        "        return 1;\n"
        "    }\n"
        '    if (strcmp(query, "dead_loop_r0_then_r1_query_relation_pair_control") == 0) {\n'
        "        *out = RELATION_SPATIAL_CONTROL_DEAD_LOOP_R0_R1_PRIMARY;\n"
        "        return 1;\n"
        "    }\n"
        '    if (strcmp(query, "dead_loop_r0_then_r1_relation_sham_control") == 0) {\n'
        "        *out = RELATION_SPATIAL_CONTROL_DEAD_LOOP_R0_R1_SHAM;\n"
        "        return 1;\n"
        "    }\n"
        '    if (strcmp(query, "dead_loop_r1_then_r0_query_relation_pair_control") == 0) {\n'
        "        *out = RELATION_SPATIAL_CONTROL_DEAD_LOOP_R1_R0_PRIMARY;\n"
        "        return 1;\n"
        "    }\n"
        '    if (strcmp(query, "dead_loop_r1_then_r0_relation_sham_control") == 0) {\n'
        "        *out = RELATION_SPATIAL_CONTROL_DEAD_LOOP_R1_R0_SHAM;\n"
        "        return 1;\n"
        "    }\n"
        '    if (strcmp(query, "source_off_loop_r0_then_r1_query_relation_pair_control") == 0) {\n'
        "        *out = RELATION_SPATIAL_CONTROL_SOURCE_OFF_LOOP_R0_R1_PRIMARY;\n"
        "        return 1;\n"
        "    }\n"
        '    if (strcmp(query, "source_off_loop_r0_then_r1_relation_sham_control") == 0) {\n'
        "        *out = RELATION_SPATIAL_CONTROL_SOURCE_OFF_LOOP_R0_R1_SHAM;\n"
        "        return 1;\n"
        "    }\n"
        '    if (strcmp(query, "source_off_loop_r1_then_r0_query_relation_pair_control") == 0) {\n'
        "        *out = RELATION_SPATIAL_CONTROL_SOURCE_OFF_LOOP_R1_R0_PRIMARY;\n"
        "        return 1;\n"
        "    }\n"
        '    if (strcmp(query, "source_off_loop_r1_then_r0_relation_sham_control") == 0) {\n'
        "        *out = RELATION_SPATIAL_CONTROL_SOURCE_OFF_LOOP_R1_R0_SHAM;\n"
        "        return 1;\n"
        "    }\n"
        '    if (strcmp(query, "gapped_loop_r0_then_r1_query_relation_pair_control") == 0) {\n'
        "        *out = RELATION_SPATIAL_CONTROL_GAPPED_LOOP_R0_R1_PRIMARY;\n"
        "        return 1;\n"
        "    }\n"
        '    if (strcmp(query, "gapped_loop_r0_then_r1_relation_sham_control") == 0) {\n'
        "        *out = RELATION_SPATIAL_CONTROL_GAPPED_LOOP_R0_R1_SHAM;\n"
        "        return 1;\n"
        "    }\n"
        '    if (strcmp(query, "gapped_loop_r1_then_r0_query_relation_pair_control") == 0) {\n'
        "        *out = RELATION_SPATIAL_CONTROL_GAPPED_LOOP_R1_R0_PRIMARY;\n"
        "        return 1;\n"
        "    }\n"
        '    if (strcmp(query, "gapped_loop_r1_then_r0_relation_sham_control") == 0) {\n'
        "        *out = RELATION_SPATIAL_CONTROL_GAPPED_LOOP_R1_R0_SHAM;\n"
        "        return 1;\n"
        "    }\n"
    ...
    text = text.replace(
        ...
        "        || row->control == RELATION_SPATIAL_CONTROL_LOOP_R0_R1_SHAM\n"
        "        || row->control == RELATION_SPATIAL_CONTROL_LOOP_R1_R0_SHAM\n"
        "        || row->control == RELATION_SPATIAL_CONTROL_DEAD_LOOP_R0_R1_SHAM\n"
        "        || row->control == RELATION_SPATIAL_CONTROL_DEAD_LOOP_R1_R0_SHAM\n"
        "        || row->control == RELATION_SPATIAL_CONTROL_SOURCE_OFF_LOOP_R0_R1_SHAM\n"
        "        || row->control == RELATION_SPATIAL_CONTROL_SOURCE_OFF_LOOP_R1_R0_SHAM\n"
        "        || row->control == RELATION_SPATIAL_CONTROL_GAPPED_LOOP_R0_R1_SHAM\n"
        "        || row->control == RELATION_SPATIAL_CONTROL_GAPPED_LOOP_R1_R0_SHAM) {\n"
    ...
    lane_a_helper = (
        ...
        "#endif\n"
        "}\n\n"
        "static void relation_spatial_touch_pair_for_loop(relation_spatial_carrier_state *state, uint32_t a_index, relation_spatial_relation_id relation, relation_spatial_order_id order) {\n"
        ...
        "    }\n"
        "}\n\n"
        "static int relation_spatial_prepare_loop_transport(relation_spatial_preparation prep, relation_spatial_carrier_state *state, relation_spatial_relation_id first, relation_spatial_relation_id second) {\n"
        "    uint32_t step = 0u;\n"
        ...
        "        uint32_t a0 = relation_spatial_origin_index(prep.cyclic_origin, step);\n"
        "        uint32_t a1 = relation_spatial_map_index(first, a0);\n"
        "        relation_spatial_touch_pair_for_loop(state, a0, first, prep.source_order);\n"
        "        relation_spatial_touch_pair_for_loop(state, a1, second, prep.source_order);\n"
        "    }\n"
        "    return 1;\n"
        "}\n\n"
        "static int relation_spatial_prepare_loop_transport_gapped(relation_spatial_preparation prep, relation_spatial_carrier_state *state, relation_spatial_relation_id first, relation_spatial_relation_id second) {\n"
        "    uint32_t step = 0u;\n"
        "    if (state == NULL || prep.cyclic_origin >= FAMILY10H_RELATION_SPATIAL_LINE_COUNT) {\n"
        "        return 0;\n"
        "    }\n"
        ...
        "    return 1;\n"
        "}\n\n"
        "static int loop_r0_r1_control(relation_spatial_control_id control);\n"
        "static int loop_r1_r0_control(relation_spatial_control_id control);\n"
        "static int gapped_loop_r0_r1_control(relation_spatial_control_id control);\n"
        "static int gapped_loop_r1_r0_control(relation_spatial_control_id control);\n\n"
        ...
        "    if (loop_r0_r1_control(control)) {\n"
        "        return relation_spatial_prepare_loop_transport(prep, state, RELATION_SPATIAL_R0, RELATION_SPATIAL_R1);\n"
        "    }\n"
        "    if (loop_r1_r0_control(control)) {\n"
        "        return relation_spatial_prepare_loop_transport(prep, state, RELATION_SPATIAL_R1, RELATION_SPATIAL_R0);\n"
        "    }\n"
        "    if (gapped_loop_r0_r1_control(control)) {\n"
        "        return relation_spatial_prepare_loop_transport_gapped(prep, state, RELATION_SPATIAL_R0, RELATION_SPATIAL_R1);\n"
        "    }\n"
        "    if (gapped_loop_r1_r0_control(control)) {\n"
        "        return relation_spatial_prepare_loop_transport_gapped(prep, state, RELATION_SPATIAL_R1, RELATION_SPATIAL_R0);\n"
        "    }\n"
    ...
    lifecycle_helpers = (
        ...
        "        || control == RELATION_SPATIAL_CONTROL_SOURCE_OFF_PRIMARY\n"
        "        || control == RELATION_SPATIAL_CONTROL_SOURCE_OFF_SHAM\n"
        "        || control == RELATION_SPATIAL_CONTROL_DEAD_LOOP_R0_R1_PRIMARY\n"
        "        || control == RELATION_SPATIAL_CONTROL_DEAD_LOOP_R0_R1_SHAM\n"
        "        || control == RELATION_SPATIAL_CONTROL_DEAD_LOOP_R1_R0_PRIMARY\n"
        "        || control == RELATION_SPATIAL_CONTROL_DEAD_LOOP_R1_R0_SHAM\n"
        "        || control == RELATION_SPATIAL_CONTROL_SOURCE_OFF_LOOP_R0_R1_PRIMARY\n"
        "        || control == RELATION_SPATIAL_CONTROL_SOURCE_OFF_LOOP_R0_R1_SHAM\n"
        "        || control == RELATION_SPATIAL_CONTROL_SOURCE_OFF_LOOP_R1_R0_PRIMARY\n"
        "        || control == RELATION_SPATIAL_CONTROL_SOURCE_OFF_LOOP_R1_R0_SHAM;\n"
        "}\n\n"
        ...
        "}\n\n"
        "static int loop_r0_r1_control(relation_spatial_control_id control) {\n"
        "    return control == RELATION_SPATIAL_CONTROL_LOOP_R0_R1_PRIMARY\n"
        "        || control == RELATION_SPATIAL_CONTROL_LOOP_R0_R1_SHAM\n"
        "        || control == RELATION_SPATIAL_CONTROL_DEAD_LOOP_R0_R1_PRIMARY\n"
        "        || control == RELATION_SPATIAL_CONTROL_DEAD_LOOP_R0_R1_SHAM;\n"
        "}\n\n"
        "static int loop_r1_r0_control(relation_spatial_control_id control) {\n"
        "    return control == RELATION_SPATIAL_CONTROL_LOOP_R1_R0_PRIMARY\n"
        "        || control == RELATION_SPATIAL_CONTROL_LOOP_R1_R0_SHAM\n"
        "        || control == RELATION_SPATIAL_CONTROL_DEAD_LOOP_R1_R0_PRIMARY\n"
        "        || control == RELATION_SPATIAL_CONTROL_DEAD_LOOP_R1_R0_SHAM;\n"
        "}\n\n"
        "static int gapped_loop_r0_r1_control(relation_spatial_control_id control) {\n"
        "    return control == RELATION_SPATIAL_CONTROL_GAPPED_LOOP_R0_R1_PRIMARY\n"
        "        || control == RELATION_SPATIAL_CONTROL_GAPPED_LOOP_R0_R1_SHAM;\n"
        "}\n\n"
        "static int gapped_loop_r1_r0_control(relation_spatial_control_id control) {\n"
        "    return control == RELATION_SPATIAL_CONTROL_GAPPED_LOOP_R1_R0_PRIMARY\n"
        "        || control == RELATION_SPATIAL_CONTROL_GAPPED_LOOP_R1_R0_SHAM;\n"
        "}\n\n"
    ...
    text = text.replace(
        ...
        "            : (source_off_control(row.control)\n"
        "                ? \"source_off_no_prepare_before_spatial_pair_probe\"\n"
...
def compile_runtime() -> dict[str, Any]:
    ...
    receipt = {
        "schema": "FAMILY10H_RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_RUNTIME_BUILD_V1",
...
def make_rows() -> dict[str, Any]:
    ...
    for variant in VARIANTS:
        ...
        for index, row in enumerate(base_rows):
            ...
            copied["control_semantics_id"] = "none" if variant == "loop_r0r1_primary" else query
        ...
        schedules[variant] = {
            "query": query,
            "path": f"RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_SCHEDULES/{variant}.tsv",
            "row_count": len(rows),
    ...
    manifest = {
        "schema": "FAMILY10H_RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_DISCOVERY_SCHEDULE_MANIFEST_V1",
        "run_id": RUN_ID,
        ...
        "mechanism_question": (
            "Does a loop-transport R0->R1 versus R1->R0 source preparation produce a primary-minus-sham "
            "orientation residue that source-off and gapped controls kill before any reset/reuse claim?"
        ),
    }
    manifest["schedule_manifest_sha256"] = digest({k: v for k, v in manifest.items() if k != "schedule_manifest_sha256"})
    write_json(SOURCE_ROOT / "RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_SCHEDULE_MANIFEST.json", manifest)
    write_json(HERE / "RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_SCHEDULE_MANIFEST.json", manifest)
    return manifest
...
receipt = {{"schema": "FAMILY10H_RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_CPUFREQ_PREPARE_V1", "created_utc": time.strftime("%Y-%m-%dT%H:%M:%SZ", time.gmtime()), "cpus": {{}}, "failures": []}}
for cpu in [4, 5]:
...
receipt = {{"schema": "FAMILY10H_RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_CPUFREQ_RESTORE_V1", "created_utc": time.strftime("%Y-%m-%dT%H:%M:%SZ", time.gmtime()), "cpus": {{}}, "failures": []}}
try:
...
for variant in {' '.join(VARIANTS)}; do
  ...
  schedule="$SOURCE_ROOT/RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_SCHEDULES/$variant.tsv"
  if [ -e "$out" ]; then
...
summary = {{"schema": "FAMILY10H_RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_TARGET_SUMMARY_V1", "run_id": "{RUN_ID}", "attempt_consumed": (root / "ATTEMPT_CONSUMED").exists(), "variants": {{}}, "small_wall_crossed": False}}
for variant in variants:
...
(root / "RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_TARGET_SUMMARY.json").write_text(json.dumps(summary, indent=2, sort_keys=True) + "\\n")
PY
...
def build_package() -> dict[str, Any]:
    ...
    with tarfile.open(LOCAL_PACKAGE, "w:gz") as tf:
        ...
        info = tarfile.TarInfo("source/RUN_RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_DISCOVERY.sh")
        info.size = len(data)
        info.mode = 0o755
        info.mtime = int(time.time())
        tf.addfile(info, io.BytesIO(data))
        files["source/RUN_RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_DISCOVERY.sh"] = {"sha256": sha256_bytes(data), "size_bytes": len(data)}
    receipt = {
        "schema": "FAMILY10H_RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_SOURCE_PACKAGE_V1",
        "created_at": utc_now(),
        "run_id": RUN_ID,
...
def deploy_execute_copyback(package: dict[str, Any]) -> dict[str, Any]:
    ...
    extract = run_remote(
        f"set -eu; tar -xzf {REMOTE_PACKAGE} -C {REMOTE_ROOT}; chmod +x {REMOTE_ROOT}/source/relation_spatial_runtime {REMOTE_ROOT}/source/relation_spatial_pmu_preflight {REMOTE_ROOT}/source/RUN_RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_DISCOVERY.sh",
        timeout=120,
    )
    require(extract["returncode"] == 0, f"extract failed: {extract['stderr']}")
    live = run_remote(f"set +e; cd {REMOTE_ROOT}/source; ./RUN_RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_DISCOVERY.sh", timeout=3600)
    ...
    copyback = {
        "schema": "FAMILY10H_RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_COPYBACK_V1",
        "created_at": utc_now(),
    ...
    if copyback["passed"]:
        ...
        cleanup = {"schema": "FAMILY10H_RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_REMOTE_CLEANUP_V1", "cleanup": cleanup_cmd, "passed": cleanup_cmd["returncode"] == 0}
    receipt = {
        "schema": "FAMILY10H_RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_LIVE_CONTROLLER_V1",
        "created_at": utc_now(),
        "run_id": RUN_ID,
        "package": package,
        "absence": absence,
...
def analyze_archive(controller: dict[str, Any]) -> dict[str, Any]:
    ...
    method_pairs = {
        ...
        "source_off": ("source_off_primary", "source_off_sham"),
    ...
    source_off_d = method_reports["source_off"]["D_primary_minus_sham"]
    ...
    reset_methods = [method for method in method_pairs if method.startswith("reset_")]
    ...
    result = {
        "schema": "FAMILY10H_RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_DISCOVERY_ANALYSIS_V1",
        "created_at": utc_now(),
        "run_id": RUN_ID,
        ...
        "coordinates": {
            ...
            "R_source_off_primary": method_reports["source_off"]["primary_R"],
            "R_source_off_sham": method_reports["source_off"]["sham_R"],
            "D_source_off_primary_minus_sham": source_off_d,
            "source_off_D_abs_to_alive_D_abs": ratio_to_alive(source_off_d),
            "source_off_max_stratum_abs_to_alive_matched_abs": stratum_reports["source_off"][
        ...
        "interpretation": {
            ...
            "source_off_kills_aggregate_below_25pct_alive_D": (
                abs(source_off_d) <= 0.25 * abs(alive_d) if alive_d else False
            ),
            "source_off_kills_all_one_factor_strata_below_25pct_alive_D": stratum_reports["source_off"][
            ...
            "candidate_persistent_source_written_state_with_reset_method": (
                ...
                and abs(source_off_d) <= 0.25 * abs(alive_d)
                and stratum_reports["source_off"]["all_one_factor_strata_below_25pct_alive_matched"]
    ...
    write_json(RUN_ROOT / "RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_DISCOVERY_ANALYSIS.json", result)
    write_json(SUMMARY_JSON, result)
    lines = [
        "# Relation R-Spatial Loop Transport Source-Off Screen Discovery",
        "",
        f"Run ID: `{RUN_ID}`",
    ...
    for method in ["alive", "dead", *reset_methods]:
    ...
    lines.extend(
        [
            ...
            f"- source-off kills aggregate below 0.25 x alive D: `{result['interpretation']['source_off_kills_aggregate_below_25pct_alive_D']}`",
            f"- source-off kills all one-factor strata below 0.25 x alive D: `{result['interpretation']['source_off_kills_all_one_factor_strata_below_25pct_alive_D']}`",
...
def analyze_archive_loop_transport_source_off_screen(controller: dict[str, Any]) -> dict[str, Any]:
    require(LOCAL_ARCHIVE.exists(), "archive missing for analysis")
    ...
    pair_variants = {
        "loop_r0r1": ("loop_r0r1_primary", "loop_r0r1_sham"),
        "loop_r1r0": ("loop_r1r0_primary", "loop_r1r0_sham"),
        "dead_loop_r0r1": ("dead_loop_r0r1_primary", "dead_loop_r0r1_sham"),
        "dead_loop_r1r0": ("dead_loop_r1r0_primary", "dead_loop_r1r0_sham"),
        "source_off_loop_r0r1": ("source_off_loop_r0r1_primary", "source_off_loop_r0r1_sham"),
        "source_off_loop_r1r0": ("source_off_loop_r1r0_primary", "source_off_loop_r1r0_sham"),
        "gapped_loop_r0r1": ("gapped_loop_r0r1_primary", "gapped_loop_r0r1_sham"),
        "gapped_loop_r1r0": ("gapped_loop_r1r0_primary", "gapped_loop_r1r0_sham"),
    }
    pair_reports: dict[str, Any] = {}
    for name, (primary_variant, sham_variant) in pair_variants.items():
        primary = reports[primary_variant]["R_spatial"]["mean"]
        sham = reports[sham_variant]["R_spatial"]["mean"]
        delta = primary - sham
        pair_reports[name] = {
    ...
    def d_by_factor(pair_name: str, factor: str) -> dict[str, float]:
        primary_variant, sham_variant = pair_variants[pair_name]
        primary_records = records_by_variant[primary_variant]
        sham_records = records_by_variant[sham_variant]
        levels = sorted(
            set(str(record[factor]) for record in primary_records) & set(str(record[factor]) for record in sham_records),
        ...
        return {
            level: (
                mean([record["R_spatial"] for record in primary_records if str(record[factor]) == level])
                - mean([record["R_spatial"] for record in sham_records if str(record[factor]) == level])
            )
            for level in levels
        }

    def omega(left: str, right: str) -> float:
        return pair_reports[left]["D_primary_minus_sham"] - pair_reports[right]["D_primary_minus_sham"]

    omegas = {
        "alive": omega("loop_r0r1", "loop_r1r0"),
        "dead": omega("dead_loop_r0r1", "dead_loop_r1r0"),
        "source_off": omega("source_off_loop_r0r1", "source_off_loop_r1r0"),
        "gapped": omega("gapped_loop_r0r1", "gapped_loop_r1r0"),
    }
    alive_omega = omegas["alive"]

    omega_strata: dict[str, Any] = {}
    alive_by_factor = {
        factor: {
            level: left_value - d_by_factor("loop_r1r0", factor)[level]
            for level, left_value in d_by_factor("loop_r0r1", factor).items()
            if level in d_by_factor("loop_r1r0", factor)
        }
        for factor in factors
    }
    pair_for_scope = {
        "alive": ("loop_r0r1", "loop_r1r0"),
        "dead": ("dead_loop_r0r1", "dead_loop_r1r0"),
        "source_off": ("source_off_loop_r0r1", "source_off_loop_r1r0"),
        "gapped": ("gapped_loop_r0r1", "gapped_loop_r1r0"),
    }
    for scope, (left, right) in pair_for_scope.items():
        factor_reports = {}
        ratios: list[float] = []
        values: list[float] = []
        for factor in factors:
            left_values = d_by_factor(left, factor)
            right_values = d_by_factor(right, factor)
            levels = sorted(set(left_values) & set(right_values) & set(alive_by_factor[factor]), key=str)
            level_reports = {}
            for level in levels:
                value = left_values[level] - right_values[level]
                ...
                level_reports[level] = {
                    "omega": value,
                    "alive_matched_omega": alive_value,
                    "abs_to_alive_matched_abs": ratio,
                    "same_sign_as_alive_aggregate": (value > 0) == (alive_omega > 0) if alive_omega else False,
                    "below_25pct_alive_matched": ratio is not None and ratio <= 0.25,
                }
            factor_reports[factor] = {
                "levels": level_reports,
        ...
        omega_strata[scope] = {
            "factors": factor_reports,
            "all_same_sign_as_alive_aggregate": all((value > 0) == (alive_omega > 0) for value in values)
            if values and alive_omega
            else False,
            "all_one_factor_strata_below_25pct_alive_matched": all(ratio <= 0.25 for ratio in ratios)
            if ratios
            else False,
    ...
    def ratio_to_alive(value: float) -> float | None:
        return abs(value) / abs(alive_omega) if alive_omega else None
    ...
    result = {
        ...
        "omega_strata": omega_strata,
        "coordinates": {
            "D_loop_r0r1_primary_minus_sham": pair_reports["loop_r0r1"]["D_primary_minus_sham"],
            "D_loop_r1r0_primary_minus_sham": pair_reports["loop_r1r0"]["D_primary_minus_sham"],
            "D_dead_loop_r0r1_primary_minus_sham": pair_reports["dead_loop_r0r1"]["D_primary_minus_sham"],
            "D_dead_loop_r1r0_primary_minus_sham": pair_reports["dead_loop_r1r0"]["D_primary_minus_sham"],
            "D_source_off_loop_r0r1_primary_minus_sham": pair_reports["source_off_loop_r0r1"]["D_primary_minus_sham"],
            "D_source_off_loop_r1r0_primary_minus_sham": pair_reports["source_off_loop_r1r0"]["D_primary_minus_sham"],
            "D_gapped_loop_r0r1_primary_minus_sham": pair_reports["gapped_loop_r0r1"]["D_primary_minus_sham"],
            "D_gapped_loop_r1r0_primary_minus_sham": pair_reports["gapped_loop_r1r0"]["D_primary_minus_sham"],
            "Omega_alive_loop_r0r1_minus_r1r0": omegas["alive"],
            "Omega_dead_loop_r0r1_minus_r1r0": omegas["dead"],
            "Omega_source_off_loop_r0r1_minus_r1r0": omegas["source_off"],
            "Omega_gapped_loop_r0r1_minus_r1r0": omegas["gapped"],
            "dead_omega_abs_to_alive_omega_abs": ratio_to_alive(omegas["dead"]),
            "source_off_omega_abs_to_alive_omega_abs": ratio_to_alive(omegas["source_off"]),
            "gapped_omega_abs_to_alive_omega_abs": ratio_to_alive(omegas["gapped"]),
        },
        "interpretation": {
            "alive_loop_omega_nonzero": alive_omega != 0,
            "dead_preserves_at_least_25pct_alive_omega": (
                abs(omegas["dead"]) >= 0.25 * abs(alive_omega) if alive_omega else False
            ),
            "source_off_collapses_below_25pct_alive_omega": (
                abs(omegas["source_off"]) <= 0.25 * abs(alive_omega) if alive_omega else False
            ),
            "gapped_collapses_below_25pct_alive_omega": (
                abs(omegas["gapped"]) <= 0.25 * abs(alive_omega) if alive_omega else False
            ),
            "source_off_all_one_factor_strata_below_25pct": omega_strata["source_off"][
                "all_one_factor_strata_below_25pct_alive_matched"
            ],
            "gapped_all_one_factor_strata_below_25pct": omega_strata["gapped"][
                "all_one_factor_strata_below_25pct_alive_matched"
            ],
            "alive_all_one_factor_strata_same_sign": omega_strata["alive"]["all_same_sign_as_alive_aggregate"],
            "loop_transport_source_off_screen_candidate": (
                alive_omega != 0
                and abs(omegas["source_off"]) <= 0.25 * abs(alive_omega)
                and abs(omegas["gapped"]) <= 0.25 * abs(alive_omega)
                and abs(omegas["dead"]) >= 0.25 * abs(alive_omega)
                and omega_strata["source_off"]["all_one_factor_strata_below_25pct_alive_matched"]
                and omega_strata["gapped"]["all_one_factor_strata_below_25pct_alive_matched"]
            )
            if alive_omega
            else False,
            "exploratory_only": True,
    ...
    for scope, left, right in rows:
        lines.append(
            f"| {scope} | {pair_reports[left]['D_primary_minus_sham']:.9f} | "
            f"{pair_reports[right]['D_primary_minus_sham']:.9f} | {omegas[scope]:.9f} | "
            f"{(ratio_to_alive(omegas[scope]) or 0.0):.3f} | "
            f"{(omega_strata[scope]['max_abs_to_alive_matched_abs'] or 0.0):.3f} |"
        )
    lines.extend(
        [
            "",
            "Discovery interpretation:",
            f"- source-off collapses below 0.25 x alive Omega: `{result['interpretation']['source_off_collapses_below_25pct_alive_omega']}`",
            f"- gapped collapses below 0.25 x alive Omega: `{result['interpretation']['gapped_collapses_below_25pct_alive_omega']}`",
            f"- dead preserves at least 0.25 x alive Omega: `{result['interpretation']['dead_preserves_at_least_25pct_alive_omega']}`",
            f"- loop-transport source-off screen candidate: `{result['interpretation']['loop_transport_source_off_screen_candidate']}`",
            "",
            "This is exploratory evidence only. It emits no prospective scientific claim and does not promote `SMALL_WALL_CROSSED`.",
        ]
    )
...
def prepare() -> dict[str, Any]:
    ...
    result = {
        "schema": "FAMILY10H_RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_PREPARE_V1",
        "created_at": utc_now(),
        "run_id": RUN_ID,
    ...
    write_json(HERE / "RELATION_LOOP_TRANSPORT_SOURCE_OFF_SCREEN_PREPARE_RESULT.json", result)
    return result
...
def main() -> int:
    ...
    analysis = analyze_archive_loop_transport_source_off_screen(controller)
    print(
        json.dumps(
            {
