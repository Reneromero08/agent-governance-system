...
def entries_by_role(manifest: dict[str, Any]) -> dict[str, dict[str, Any]]:
    ...
    for entry in manifest["files"]:
        ...
        roles[role] = entry
    for role in ("host_adapter", "target_runner", "target_worker"):
...
def validate_execution_authority(
    ...
    *,
    ...
    exact_manifest = bundle.validate_committed_manifest_exact(expected_manifest, manifest_treeish)
    ...
    require(authority["schedule_sha256"] == bundle.SCHEDULE_SHA256, "schedule digest mismatch")
    require(authority["target_namespace_sha256"] == bundle.NAMESPACE_SHA256, "target namespace digest mismatch")
    require(authority["target_identity_sha256"] == bundle.TARGET_IDENTITY_SHA256, "target identity digest mismatch")
...
def load_and_validate_execution_authority(
    ...
    *,
    ...
    validate_execution_authority(
        ...
        manifest_treeish=manifest_treeish,
    )
    return authority
