...
machine = load_module(MACHINE_SOURCE, "catcas_waveform_ising_v3_six_site_preoracle_machine")
controls = load_module(CONTROL_SOURCE, "catcas_waveform_ising_v3_six_site_preoracle_controls")
...
class EventLedger:
    ...
    def document(self) -> dict[str, Any]:
        return {
            ...
            "schema": "catalytic_waveform_ising_v3_six_site_preoracle_trace_v1",
        }
...
def build_documents(
    ...
    evidence = {
        ...
        "machine_fingerprint": expected_machine_fingerprint,
        "oracle_opened": False,
        "schema": "catalytic_waveform_ising_v3_six_site_preoracle_evidence_v2",
    ...
    seal = {
        ...
        "machine_fingerprint": expected_machine_fingerprint,
        "oracle_call_count": calls["oracle"],
        "schema": "catalytic_waveform_ising_v3_six_site_preoracle_seal_v2",
