...
full retained-raw execution: REQUIRES CATCAS HOST BUNDLE
```
...
The generated result remains a derived analysis. It does not change the frozen campaign, the historical T300 artifacts, or the official `PARTIAL` state.
