...
| `14_noncollapse_frontier/results/class_b/*.holo` | Per-trial .holo records. | Full process-object per the schema. | Scalar answer file. |
| `14_noncollapse_frontier/results/class_b/summary.csv` | Trial-level summary. | trial_id, seed, N, Q_diff, controls_pass, verdict. | winner, recovered_d, orientation_auc. |
