...
- **Dry-run .holo:** `14_noncollapse_frontier/results/class_b/scaffold_dry_run.holo` -- generated at runtime, gitignored per `**/*.holo`
...
- `14_noncollapse_frontier/results/class_b/scaffold_dry_run.holo` -- `**/*.holo` in `.gitignore`
