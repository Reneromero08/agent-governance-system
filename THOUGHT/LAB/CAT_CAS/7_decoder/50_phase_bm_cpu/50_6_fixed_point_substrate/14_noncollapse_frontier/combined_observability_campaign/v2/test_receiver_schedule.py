...
class ReceiverScheduleTests(unittest.TestCase):
    def test_projection_removes_logically_separated_sender_fields(self) -> None:
        row = {
            "window_index": 0,
        ...
        self.assertFalse(SENDER_SEPARATED_FIELDS & visible.keys())
        self.assertEqual(visible["receiver_theta_idx"], 2)

    def test_logical_separation_produces_distinct_physical_gate_digest(self) -> None:
