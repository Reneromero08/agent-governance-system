...
- `fixed_point_convergence.c` now uses a unique fixed point and requires a final SSH rerun.
...
```text
T300 proves: selected PDN carrier/channel is live for sender-owned mode and phase.
T300 does not prove: public fold-odd generation, HoloGeometry, path memory, or restoration.
