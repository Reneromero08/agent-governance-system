...
that, on the real code path lifted verbatim into construction.py (== 49_14_substrate.py).
...
import construction as C                  # verbatim copy of 49_14 coset_samples/make_verify
...
def main():
    t0 = time.time()
    log("=" * 90)
    log("PART A - GENERATOR AUDIT of the REAL Exp 50.14 construction (construction.py == 49_14)")
