"""
fold_audit.py - STAGE 1 FOLD AUDIT (Exp 50 Phase 6).
...
def main():
    t0 = time.time()
    log("=" * 100)
    log("STAGE 1 FOLD AUDIT  -  Exp 50 Phase 6  -  is the orientation bit absent from the scalar channel?")
    ...
    results = {"master_seed": MASTER_SEED, "seeds": seeds,
               "construction": "Exp50.14 (49_14_substrate.py coset_samples/make_verify; SPEC_PHASE6 Sec2)",
