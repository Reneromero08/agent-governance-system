...
# -*- coding: utf-8 -*-
"""
EXP50 Phase 5.10 analysis pipeline (host-independent, buildable now).
...
Discipline (binding, per the Exp 50 manifesto / the 5.10 gate spec):
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="EXP50 Phase 5.10 analysis pipeline")
