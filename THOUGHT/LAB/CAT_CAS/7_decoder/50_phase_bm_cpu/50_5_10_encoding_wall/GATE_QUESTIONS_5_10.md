...
Exp 50 honesty audit. Claim ceiling L4-5.
...
`EXP50_PHASE5_10_NO_REPRODUCIBLE_BASIN` (a hard verdict, NOT a soft PARTIAL).
...
-> `EXP50_PHASE5_10_READY_FOR_PHASE6`. Anything less is PARTIAL / BLOCKED / NO_REPRODUCIBLE_BASIN, and
