...
1. **ROADMAP.md**: 2B.2 marked COMPLETE/NEGATIVE. 2B.3B marked COMPLETE with P1 FALSIFIED, P2 ACTIVE. 2B.4 marked COMPLETE / CURRENT PASSIVE MECHANISMS CLOSED. Phase 2 header updated. Phase 3.13 added (Active Catalytic Ising Solver, promoted from P2). Phase 3 verdict updated.
