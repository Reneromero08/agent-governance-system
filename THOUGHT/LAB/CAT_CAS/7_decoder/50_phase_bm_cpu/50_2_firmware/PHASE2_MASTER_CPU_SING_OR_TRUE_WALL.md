...
|---|---|---|---|
| 1: rebuild toolchain | `NOOP_REBUILD_PROVEN` | Public LongSoft `old_engine` source was fetched into ignored tool tree, a temporary Qt/qmake force-save UEFIReplace variant was built on the Linux target, and identical AmdProcessorInitPeim PE32 body replacement produced `50_2_firmware/cpu_hack/noop_replace/bios_noop_rebuilt.bin`. The rebuilt image parses cleanly, is byte-identical to stock, and preserves target body SHA-256 `BF92A1321B98908E7D74299A6C1E629EC3583599F164DEC6E774BFF040FBDF2A`. | Do not repeat no-op rebuild. Use this proof only if a future P4-only static edit target is found. |
...
- `50_2_firmware/PHASE2_P4_EDIT_SOURCE_PROOF.md`
- `50_2_firmware/cpu_hack/agesa_trace/AmdProcessorInitPeim_p4_edit_source_probe.txt`
- `50_2_firmware/PHASE2_RUNTIME_MSR_OBSERVER_REPORT.md`
- `50_2_firmware/PHASE2_RUNTIME_LOAD_AFFINITY_REPORT.md`
- `50_2_firmware/PHASE2_RUNTIME_TRANSITION_JITTER_REPORT.md`
- `50_2_firmware/PHASE2_RUNTIME_STATE_WINDOW_ORACLE_REPORT.md`
- `50_2_firmware/PHASE2_RUNTIME_P4_ASYMMETRY_ORACLE_REPORT.md`
- `50_2_firmware/PHASE2_RUNTIME_P4_ASYMMETRY_ORACLE.json`
- `50_2_firmware/PHASE2_EFFECTIVE_STATE_SELECTOR_MAP_REPORT.md`
- `50_2_firmware/PHASE2_EFFECTIVE_STATE_SELECTOR_MAP.json`
- `50_2_firmware/PHASE2_STATE_LABEL_PHASE_COUPLING_REPORT.md`
- `50_2_firmware/PHASE2_STATE_LABEL_PHASE_COUPLING_PROBE_BALANCED_SEED1000.json`
- `50_2_firmware/PHASE2_STATE_LABEL_PHASE_COUPLING_PROBE_BALANCED_SEED5000.json`
- `50_2_firmware/PHASE2_STATE_LABEL_TIMING_EDGE_STABILITY_SWEEP.md`
- `50_2_firmware/PHASE2_STATE_LABEL_TIMING_EDGE_STABILITY_SWEEP.csv`
- `50_2_firmware/PHASE2_STATE_LABEL_TIMING_EDGE_NARROWING_SWEEP.md`
- `50_2_firmware/PHASE2_STATE_LABEL_HARDNULL_SWEEP.md`
- `50_2_firmware/PHASE2_STATE_LABEL_HARDNULL_FOCUS_SWEEP.md`
- `50_2_firmware/PHASE2_STATE_LABEL_TIMING_EDGE_HARDENED_REPORT.md`
- `50_2_firmware/PHASE2_STATE_LABEL_MODAL_FEATURE_SEARCH.md`
- `50_2_firmware/PHASE2_STATE_LABEL_MODAL_VALIDATION.md`
- `50_2_firmware/PHASE2_SCHEDULER_TOPOLOGY_RESONANCE_HARDENED.md`
- `50_2_firmware/PHASE2_FIRMWARE_P4_SEPARATE_SOURCE_SEARCH.md`
- `50_2_firmware/PHASE2_FIRMWARE_P4_SEPARATE_SOURCE_DEEPENED.md`
...
- `50_2_firmware/PHASE2_CPU_DXE_VALUE_CONSUMER_TRACE.md`
- `50_2_firmware/PHASE2_CPU_PEI_VALUE_CONSUMER_TRACE.md`
- `50_2_firmware/PHASE2_LEGACY_REGION_VALUE_CONSUMER_TRACE.md`
- `50_2_firmware/PHASE2_F10_SOURCE_PSTATE_VALUE_PROVENANCE.md`
- `50_5_10_encoding_wall/PHASE5_10D_CACHE_ADDRESS_TOPOLOGY_LIVE.md`
- `50_5_10_encoding_wall/PHASE5_10D_CACHE_SET_ADDRESS_TOPOLOGY_PREP.md`
- `50_5_10_encoding_wall/results/live_5_10d_cache_addr/phase5_10d_cache_address_topology_report.json`
- `50_5_10_encoding_wall/results/live_5_10d_cache_addr_swap/phase5_10d_cache_address_topology_report.json`
- `50_5_10_encoding_wall/src/phase5_10_cache_address_topology.c`
- `50_5_10_encoding_wall/src/analyze_phase5_10d_cache_address.py`
- `50_2_phase_locked_network/PHASE2_CACHELINE_PHASE_COUPLING.md`
- `50_2_phase_locked_network/PHASE2B_5B_OPTICAL_3SAT_PORT.md`
- `50_2_phase_locked_network/PHASE2B_5C_BLOCH_COMPLEX_ISING_PORT.md`
- `50_2_phase_locked_network/PHASE2B_5D_SPECTRAL_PROBLEM_CLASSIFIER.md`
- `50_2_phase_locked_network/PHASE2B_5E_HOLO_MERA_BRIDGE.md`
- `50_2_phase_locked_network/PHASE2B_5_ANSWER_AS_MEASUREMENT.md`
- `50_2_phase_locked_network/PHASE2B_6_CHANNEL_MATRIX.md`
- `50_2_phase_locked_network/PHASE2B_7_RESTORATION_GATE.md`
- `50_2_phase_locked_network/PHASE2B_8_DECISION_TREE.md`
- `50_3b_substrate_primitive/PHASE3B_CATALYTIC_SUBSTRATE_PRIMITIVE.md`
- `50_3b_substrate_primitive/src/catalytic_invariant_probe.c`
- `50_3b_substrate_primitive/results/invariant_probe_summary.csv`
- `50_4_holo_eigenbasis/PHASE4_3_RESIDUAL_CHANNEL.md`
- `50_4_holo_eigenbasis/src/residual_channel.c`
- `50_4_holo_eigenbasis/PHASE4_4A_OPERATOR_GOE.md`
- `50_4_holo_eigenbasis/src/operator_goe.c`
- `50_4_holo_eigenbasis/PHASE4_5_HOLO_MINI_MODEL.md`
- `50_4_holo_eigenbasis/src/holo_mini_model.c`
- `50_4_holo_eigenbasis/PHASE4_6_PUBLIC_HOLO_HARNESS.md`
- `50_4_holo_eigenbasis/src/catcas_holo_harness.c`
- `50_2_firmware/PHASE2_MASTER_A_DISPATCH_SOURCE.md`
- `50_2_firmware/PHASE2_MASTER_B_REBUILD_TOOLCHAIN.md`
- `50_2_firmware/PHASE2_MASTER_C_BIOS_MOD_DONORS.md`
- `50_2_firmware/PHASE2_MASTER_CPU_SING_OR_TRUE_WALL.md`
- `50_1_subthreshold_msr/src/msr_p4_readonly_observer.py`
- `50_1_subthreshold_msr/src/msr_load_affinity_characterizer.py`
- `50_1_subthreshold_msr/src/msr_transition_jitter_probe.py`
- `50_1_subthreshold_msr/src/msr_state_window_oracle.py`
- `50_1_subthreshold_msr/src/msr_effective_state_selector_map.py`
- `50_1_subthreshold_msr/src/msr_state_label_phase_coupling_probe.py`
- `50_1_subthreshold_msr/src/summarize_state_label_sweep.py`
- `50_1_subthreshold_msr/src/analyze_state_label_modal_features.py`
- `50_2_phase_locked_network/src/scheduler_topology_resonance.c`
- `50_2_phase_locked_network/src/analyze_scheduler_topology_resonance.py`
- `50_2_firmware/src/find_p4_sources_across_bios.py`
- `50_2_phase_locked_network/src/cacheline_phase_coupling.c`
- `50_2b_blackbox/src/optical_3sat_phase_port.c`
- `50_2b_blackbox/src/bloch_complex_ising.c`
- `50_2b_blackbox/src/spectral_problem_classifier.c`
- `50_2b_blackbox/src/holo_mera_bridge.c`
