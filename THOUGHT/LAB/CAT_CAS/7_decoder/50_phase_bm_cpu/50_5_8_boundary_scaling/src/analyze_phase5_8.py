...
def compute_verdict(gates):
    ...
    # Check for blocked
    if g1 == 'FAIL':
        return 'EXP50_PHASE5_8_BLOCKED_BY_PLATFORM'

    # Check for artifact-dominant
    if g9 == 'FAIL':
        return 'EXP50_PHASE5_8_ARTIFACT_DOMINANT'

    # Check for noise-only
    if g4 == 'FAIL' and g5 == 'FAIL' and g7 == 'FAIL':
        return 'EXP50_PHASE5_8_NOISE_ONLY'

    # Check for boundary rejected
    if g2 == 'FAIL':
        return 'EXP50_PHASE5_8_BOUNDARY_REJECTED'
    ...
    if silicon_passes and g8 == 'PASS':
        return 'EXP50_PHASE5_8_AREA_LAW_CONFIRMED'
    elif silicon_passes:
        return 'EXP50_PHASE5_8_SILICON_BOUNDARY_CONFIRMED'

    # Transition pass
    if g7 == 'PASS' and g2 == 'PASS':
        return 'EXP50_PHASE5_8_DIGITAL_TO_SILICON_TRANSITION_CONFIRMED'

    # Partial
    if g4 == 'PASS' and g2 == 'PASS':
        return 'EXP50_PHASE5_8_PARTIAL_BOUNDARY_DEFORMATION'
...
def main():
    ...
    # Summary
    print("\n" + "=" * 60)
    print("EXP50 PHASE 5.8: BARE-METAL HOLOGRAPHIC BOUNDARY PROBE")
    print("=" * 60)
    for gate, result in sorted(gates.items()):
