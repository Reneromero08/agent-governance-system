...
sys.path.insert(0, str(CAT_CAS_DIR / "4_holographic" / "33_mera_compression"))
...
if __name__ == "__main__":
    ...
    if not manifest_path.exists() or not Path("THOUGHT/LAB/CAT_CAS/4_holographic/33_mera_compression/qwen_27b_llm_wormhole.holo").exists():
