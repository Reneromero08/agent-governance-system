...
from constraint_relational_trace_v1.polynomial_phase_flow_census import (  # noqa: E402
    run_three_variable_polynomial_phase_flow_census,
)


def test_exhaustive_three_variable_phase_flow_census() -> None:
    census = run_three_variable_polynomial_phase_flow_census()
