...
EXP_FILE = os.path.join(EXP_DIR, '47_2_electron_edge_states', '47_2_electron_edge_states.py')
sys.path.insert(0, os.path.join(EXP_DIR, '47_2_electron_edge_states'))
...
try:
    with contextlib.redirect_stdout(output_buf):
        old_cwd = os.getcwd()
        os.chdir(os.path.join(EXP_DIR, '47_2_electron_edge_states'))
