...
- `EXP44_PHASE5_8_ARTIFACT_DOMINANT` — Migration, scheduler effects, trial order, or timing overhead explain result
...
- Roadmap: `../SSH_ROADMAP.md` (Phase 5.8 section at lines 1267-1332)
