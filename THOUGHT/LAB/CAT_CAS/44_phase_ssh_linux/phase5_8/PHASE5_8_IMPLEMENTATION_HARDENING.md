...
The prior `EXP44_PHASE5_8_AREA_LAW_CONFIRMED` label was temporarily too strong because the artifact audit was PARTIAL. The result supported a real silicon boundary and volume-beating boundary scaling, but strict area-law confirmation requires:
