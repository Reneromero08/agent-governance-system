# EXP44 PHASE 5.10B - PREP-LEVER / PRELUDE BASIN SCAN
...
HARD verdict `EXP44_PHASE5_10_NO_REPRODUCIBLE_BASIN`, not a soft PARTIAL: the rail carries the 5.10A
...
`EXP44_PHASE5_10_NO_REPRODUCIBLE_BASIN`, **NOT** a soft PARTIAL. This is committed here, before data, so it
