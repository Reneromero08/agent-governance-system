...
Verdict labels (from the spec, NOT invented here):
  ...
  EXP44_PHASE5_10_READY_FOR_PHASE6_FIXED_POINT   (Gate-8 PASS only)
...
V_CONFIRMED = "EXP44_PHASE5_10_BOUNDARY_STATE_PREPARATION_CONFIRMED"
V_PARTIAL = "EXP44_PHASE5_10_BASIN_STRUCTURE_CONFIRMED_SELECTION_PARTIAL"
V_INSTR_BLOCKED = "EXP44_PHASE5_10_INSTRUMENTATION_BLOCKED"
V_NO_SELECTION = "EXP44_PHASE5_10_NO_REPRODUCIBLE_BASIN"
V_ARTIFACT = "EXP44_PHASE5_10_ARTIFACT_DOMINANT"
V_READY = "EXP44_PHASE5_10_READY_FOR_PHASE6_FIXED_POINT"
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="EXP44 Phase 5.10 aggregator")
