...
No-op rebuild workflow is proven; do not repeat it unless validating a future non-no-op candidate. All outputs must remain inside `THOUGHT/LAB/CAT_CAS/44_phase_ssh_linux`.
