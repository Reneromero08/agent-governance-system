...
def main():
    ...
    print("=" * 60)
    print("EXP44 PHASE 5.9: CROSS-RUN MASTER VERDICT")
    print("=" * 60)
    ...
    if fail_count > 0:
        ...
        final_verdict = 'EXP44_PHASE5_9_GEOMETRY_COLLAPSES_BEFORE_FAILURE'
    elif regime == 'GEOMETRY_INVARIANT_TO_FAILURE':
        final_verdict = 'EXP44_PHASE5_9_GEOMETRY_INVARIANT_TO_FAILURE'
    elif regime == 'GEOMETRY_NOISE_ONLY':
        final_verdict = 'EXP44_PHASE5_9_NOISE_ONLY'
    else:
        final_verdict = 'EXP44_PHASE5_9_BOUNDARY_STRESS_CONFIRMED'
