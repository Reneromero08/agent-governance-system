...
- Local board evidence: [REPORT.md](REPORT.md), [SSH_ROADMAP.md](SSH_ROADMAP.md), [cpu_hack/catcas_vrm_probe.log](cpu_hack/catcas_vrm_probe.log).
...
From [SSH_ROADMAP.md](SSH_ROADMAP.md) and [cpu_hack/catcas_vrm_probe.log](cpu_hack/catcas_vrm_probe.log):
...
From [SSH_ROADMAP.md](SSH_ROADMAP.md):
