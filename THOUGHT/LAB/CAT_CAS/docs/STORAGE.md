...
| 46_phase_bio | `46_6_morphogenesis_oracle/cell_data/23_09_CODEX_HuBMAP_alldata_Dryad_merged.csv` | 2.8 GB | HuBMAP CODEX single-cell dataset for the morphogenesis oracle | external download (Dryad); see exp 46_6 REPORT | 2.8 GB, external dataset |
| 42_computational_event_horizon | `COSMOS/exp_28_holographic_entropy_screen/telemetry/boundary_cloud_raw.csv` | 133 MB | Raw boundary-cloud telemetry from exp 28 | re-run exp_28 | regenerable telemetry |
| 42_computational_event_horizon | `ULTRA/exp_14_boltzmann_brain/rust/mri_*.bin` | 39 MB x4 | Rust simulation state dumps (recursive/emergence/collision/discard) | re-run exp_14 rust build | regenerable |
