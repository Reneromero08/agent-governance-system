...
**Hardening**: 3 gates each. Known limitation documented: uniform $\pm 1$ sequences are spatially crystalline regardless of discrepancy.
...
- **The Sensor** measures the geometry of hardness. The fractal dimension, the
  ...
  invariants that classify the computational phase.
...
The sensor proves the barrier exists. The solver proves it can be crossed with
the right substrate. Together, they resolve the problem completely.
