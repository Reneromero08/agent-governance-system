...
### Problem: Graph Search Path Inefficiency
...
### Solution: Meta-HNSW and Sub-HNSW Partitioning


## RDMA-friendly graph index storage layout in remote memory. {#sec:design:layout}
## RDMA-Friendly Graph Index Storage Layout
...
### Challenge 1: Non-Contiguous Cluster Storage


### Challenge 2: Dynamic Vector Insertion Fragmentation
...
### Memory Layout Solution: Group-Based Allocation


#### Global Metadata Block Structure
...
#### Group Allocation and Overflow Memory


### Doorbell Batching for Non-Contiguous Access
...
### Online Deduplication of Sub-HNSW Clusters


#### Single-Load-Per-Batch Optimization
...
### Example: Multi-Query Batch Processing
...
### Query Result Caching for Subsequent Batches
