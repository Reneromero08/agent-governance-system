...
numerical_error_t numerical_matrix_add_accelerate(const ComplexFloat* a, const ComplexFloat* b, ComplexFloat* c, size_t m, size_t n) { return NUMERICAL_ERROR_NOT_IMPLEMENTED; }
numerical_error_t numerical_vector_dot_accelerate(const ComplexFloat* a, const ComplexFloat* b, ComplexFloat* result, size_t n) { return NUMERICAL_ERROR_NOT_IMPLEMENTED; }
numerical_error_t numerical_svd_accelerate(const ComplexFloat* a, ComplexFloat* u, float* s, ComplexFloat* vt, size_t m, size_t n) { return NUMERICAL_ERROR_NOT_IMPLEMENTED; }
numerical_error_t numerical_qr_accelerate(const ComplexFloat* a, ComplexFloat* q, ComplexFloat* r, size_t m, size_t n) { return NUMERICAL_ERROR_NOT_IMPLEMENTED; }
numerical_error_t numerical_eigendecomposition_accelerate(const ComplexFloat* a, ComplexFloat* eigenvectors, float* eigenvalues, size_t n) { return NUMERICAL_ERROR_NOT_IMPLEMENTED; }
numerical_error_t numerical_cholesky_accelerate(const ComplexFloat* a, ComplexFloat* l, size_t n) { return NUMERICAL_ERROR_NOT_IMPLEMENTED; }
numerical_error_t numerical_lu_accelerate(const ComplexFloat* a, ComplexFloat* l, ComplexFloat* u, size_t m, size_t n) { return NUMERICAL_ERROR_NOT_IMPLEMENTED; }
numerical_error_t numerical_solve_triangular_accelerate(const ComplexFloat* a, const ComplexFloat* b, ComplexFloat* x, size_t n, size_t nrhs, bool upper) { return NUMERICAL_ERROR_NOT_IMPLEMENTED; }
numerical_error_t numerical_solve_symmetric_accelerate(const ComplexFloat* a, const ComplexFloat* b, ComplexFloat* x, size_t n, size_t nrhs) { return NUMERICAL_ERROR_NOT_IMPLEMENTED; }
...
numerical_error_t numerical_matrix_multiply_accelerate(const ComplexFloat* a, const ComplexFloat* b, ComplexFloat* c, size_t m, size_t k, size_t n, bool ta, bool tb) { return NUMERICAL_ERROR_NOT_IMPLEMENTED; }
numerical_error_t numerical_matrix_add_accelerate(const ComplexFloat* a, const ComplexFloat* b, ComplexFloat* c, size_t m, size_t n) { return NUMERICAL_ERROR_NOT_IMPLEMENTED; }
numerical_error_t numerical_vector_dot_accelerate(const ComplexFloat* a, const ComplexFloat* b, ComplexFloat* result, size_t n) { return NUMERICAL_ERROR_NOT_IMPLEMENTED; }
numerical_error_t numerical_svd_accelerate(const ComplexFloat* a, ComplexFloat* u, float* s, ComplexFloat* vt, size_t m, size_t n) { return NUMERICAL_ERROR_NOT_IMPLEMENTED; }
numerical_error_t numerical_qr_accelerate(const ComplexFloat* a, ComplexFloat* q, ComplexFloat* r, size_t m, size_t n) { return NUMERICAL_ERROR_NOT_IMPLEMENTED; }
