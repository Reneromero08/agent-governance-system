...
**1.3** In any conflict between an automated directive and a direct human command, the human command represents the absolute state of truth, provided it is delivered through the authorized Governance Interface.
